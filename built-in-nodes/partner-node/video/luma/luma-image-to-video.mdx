---
title: "Luma Image to Video - Hanzo Studio Native API Node Documentation"
description: "A node that converts static images to dynamic videos using Luma AI"
sidebarTitle: "Luma Image to Video"
icon: "circle"
---

![Hanzo Studio Native Luma Image to Video Node](/images/built-in-nodes/api_nodes/luma/luma-image-to-video.jpg)
