---
title: "Luma Text to Video - Hanzo Studio Native Node Documentation"
description: "A node that converts text descriptions to videos using Luma AI"
sidebarTitle: "Luma Text to Video"
icon: "circle"
---

![Hanzo Studio Native Luma Text to Video Node](/images/built-in-nodes/api_nodes/luma/luma-text-to-video.jpg)
