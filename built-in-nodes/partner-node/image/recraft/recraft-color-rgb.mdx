---
title: "Recraft Color RGB - Hanzo Studio Native Node Documentation"
description: "Helper node for defining color controls in Recraft image generation"
sidebarTitle: "Recraft Color RGB"
icon: "circle"
---

![Hanzo Studio Native Recraft Color RGB Node](/images/built-in-nodes/api_nodes/recraft/recraft-color-rgb.jpg)
