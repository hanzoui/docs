---
title: "Luma Text to Image - Hanzo Studio Native Node Documentation"
description: "A node that converts text descriptions into high-quality images using Luma AI"
sidebarTitle: "Luma Text to Image"
icon: "circle"
---

![Hanzo Studio Native Luma Text to Image Node](/images/built-in-nodes/api_nodes/luma/luma-text-to-image.jpg)
