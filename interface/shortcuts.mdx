---
title: "Hanzo Studio Keyboard Shortcuts and Custom Settings"
description: "Keyboard and mouse shortcuts for Hanzo Studio and related settings"
sidebarTitle: "Keybinding"
icon: "keyboard"
---

{/*
description: "A list of keyboard and mouse shortcuts for Hanzo Studio"
*/}

{/* TODO(yoland): Add this back to comfyUI readme page */}


Currently, Hanzo Studio supports custom keyboard shortcuts. You can set the shortcuts by clicking on `Settings (gear icon)` --> `Keybinding`.

![Hanzo Studio Shortcut Settings](/images/interface/setting/keybinding.jpg)

In the corresponding menu, you can see all the current shortcut settings for Hanzo Studio. Click the `edit icon` before the corresponding command to customize the shortcut.

Below is the current list of shortcuts for Hanzo Studio, which you can customize as needed.
