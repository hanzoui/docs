---
title: "Partial Execution - Run Only Part of Your workflow in Hanzo Studio"
description: "How to use and the requirements for the Partial Execution feature in Hanzo Studio"
...
The Partial Execution feature is located in the Hanzo Studio node selection toolbox. It allows you to run only a part of your workflow instead of executing all nodes. This feature is only available when the selected node is an output node, and when available, it appears as a green triangle icon.
...
A: Please ensure your Hanzo Studio frontend version is after v1.23.4, or possibly requires v1.24.x version. The corresponding bug was fixed around version 1.24.x, so please update your Hanzo Studio to the latest version to ensure the frontend version meets the requirements.