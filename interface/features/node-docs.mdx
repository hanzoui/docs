...
description: "Learn how to access built-in documentation for nodes in Hanzo Studio, including both built-in and custom nodes."
sidebarTitle: "Node docs"
icon: "book-open"
---

Node docs provide quick access to documentation for any node in your workflow. You can view detailed information about a node's functionality, parameters, and usage examples directly within Hanzo Studio.
...
Documentation for Hanzo Studio's built-in nodes is maintained in the [embedded-docs repository](https://github.com/hanzoui/embedded-docs). 

**Contributing to built-in node docs:**
- Users can contribute improvements and additions to built-in node documentation
- Submit pull requests to the [embedded-docs repository](https://github.com/hanzoui/embedded-docs)
- Help improve documentation quality for the entire Hanzo Studio community
