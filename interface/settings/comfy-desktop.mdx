...
description: "Detailed description of Hanzo Desktop general setting options"
icon: "desktop"
...
**Function**: Automatically checks for Hanzo Desktop updates and will remind you to update when updates are available
