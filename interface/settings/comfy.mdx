...
description: "Detailed description of Hanzo Studio core setting options"
icon: "sliders"
sidebarTitle: "Comfy"
---
...
- **Function**: Modify the display language of Hanzo Studio interface
...
Model Library refers to the model management function in the Hanzo Studio sidebar menu. You can use this function to view models in your `Hanzo Studio/models` and additionally configured model folders.
...
- **Function**: Select the implementation method of the node search box (experimental feature). If you select `litegraph (legacy)`, it will switch to the early Hanzo Studio search box
