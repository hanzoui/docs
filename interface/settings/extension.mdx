...
description: "Detailed description of Hanzo Studio extension management and setting options"
icon: "puzzle-piece"
sidebarTitle: "Extension"
---

The Extension settings panel is a special management panel in the Hanzo Studio frontend settings system, specifically used to manage the enable/disable status of frontend extension plugins. Unlike Custom Nodes, this panel is only used to manage frontend extensions registered by custom nodes, not to disable custom nodes themselves.

![extension](/images/interface/setting/extension/extension.jpg)

These frontend extension plugins are used to enhance the Hanzo Studio experience, such as providing shortcuts, settings, UI components, menu items, and other features.
...
This Extension settings panel is essentially a "frontend plugin manager" that allows users to flexibly control Hanzo Studio's functional modules.