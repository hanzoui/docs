---
title: "Hanzo Studio 3D Settings"
description: "Detailed description of Hanzo Studio 3D setting options"
icon: "cube"
sidebarTitle: "3D"
---

This section of settings is mainly used to control the initialization settings of 3D-related components in Hanzo Studio, including camera, lighting, scene, etc. When creating new 3D components, they will be initialized according to these settings. After creation, these settings can still be adjusted individually.
...
The light settings in this section are used to set the default lighting settings for 3D components. The corresponding settings in the 3D settings in Hanzo Studio can also be modified.
