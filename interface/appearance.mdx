---
title: "Customizing Hanzo Studio Appearance"
description: "Learn how to customize the appearance of Hanzo Studio using color palettes and advanced CSS options"
...
Hanzo Studio offers flexible appearance customization options that allow you to personalize the interface to your preferences.

## Color Palette System

The primary way to customize Hanzo Studio's appearance is through the built-in color palette system.

![Color Palette](/images/interface/setting/appearance/color-palette.jpg)

This allows you to:

1. Switch Hanzo Studio themes
...
<Tip>
  ...
  2. Since we are still iterating frequently, the content below may change with Hanzo Studio frontend updates. If you need to modify, please export the theme configuration from settings and then modify it.
</Tip>
...
```json
{
  ...
  "colors": {
    ...
    "comfy_base": {                  // Hanzo Studio base interface configuration
...
- **Requirements**: Hanzo Studio frontend version 1.20.5 or newer
...
- Hanzo Studio frontend version 1.20.5 or newer

### Setting Up user.css

1. Create a file named `user.css` in your Hanzo Studio user directory (same location as your workflows and settings - see location details below)
2. Add your custom CSS rules to this file
3. Restart Hanzo Studio or refresh the page to apply changes

### User Directory Location

<UserDirectory/>

After finding the above folder location, please copy the corresponding CSS file to the corresponding user directory, such as the default user folder being `Hanzo Studio/user/default`, then restart Hanzo Studio or refresh the page to apply changes.
