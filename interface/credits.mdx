...
description: "In this article, we will introduce Hanzo Studio's credit management features, including how to obtain, use, and view credits."
sidebarTitle: "Credits"
icon: "coins"
---

The credit system was added to support the `Partner Nodes`, as calling closed-source AI models requires token consumption, so proper credit management is necessary. By default, the credits interface is not displayed. Please first log in to your Hanzo Studio account in `Settings` -> `User`, and then you can view your associated account's credit information in `Settings` -> `Credits`.

![Hanzo Studio Credits Interface](/images/interface/setting/menu-credits.jpg)

<Note>
Hanzo Studio will always remain fully open-source and free for local users.
</Note>
...
<Step title="Log in to your Hanzo Studio account">
Log in to your Hanzo Studio account in `Settings` -> `User`
...
2. Confirm that the email is the same as your Hanzo Studio registration email
