...
description: Learn how to create a new Comfy account for Hanzo Studio to access all features and services.
---
...
You can create a Comfy account for Hanzo Studio directly on Comfy Cloud:
...
If you have Hanzo Studio installed locally, you can create a Comfy account through the application:
...
- Start using Hanzo Studio features
