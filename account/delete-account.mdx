...
description: Learn how to permanently delete your Comfy account for Hanzo Studio and associated data.
---
...
- **Backup your data**: For Comfy Cloud users, your assets are stored under your account, so back up any data you want to keep. If you don't use Comfy Cloud, your API usage can be found at https://platform.hanzo.ai/
...
To permanently delete your Comfy account for Hanzo Studio, send a deletion request to [support@hanzo.ai](mailto:support@hanzo.ai).
