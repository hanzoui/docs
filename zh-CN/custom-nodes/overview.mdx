...
示例节点代码：
- [cookiecutter-comfy-extension](https://github.com/hanzoui/cookiecutter-extension)
- [Hanzo Studio-React-Extension-Template](https://github.com/hanzoui/studio-React-Extension-Template)
- [Hanzo Studio_frontend_vue_basic](https://github.com/jtydhr88/Hanzo Studio_frontend_vue_basic)
