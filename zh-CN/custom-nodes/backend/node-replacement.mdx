...
Hanzo Studio 核心使用节点替换进行内置节点迁移。以下是 [`comfy_extras/nodes_replacements.py`](https://github.com/hanzoui/studio/blob/master/comfy_extras/nodes_replacements.py) 中的实际示例：
...
查看前端实现：
- [业务逻辑 PR #8364](https://github.com/hanzoui/studio_frontend/pull/8364)
- [附加逻辑 PR #8483](https://github.com/hanzoui/studio_frontend/pull/8483)
- [UI 视图 PR #8604](https://github.com/hanzoui/studio_frontend/pull/8604)
