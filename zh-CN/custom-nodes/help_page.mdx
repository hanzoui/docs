---
title: "为你的 Hanzo Studio 自定义节点添加节点文档"
sidebarTitle: "节点文档"
...
如果你在节点的相关描述信息中已经添加的每个参数的说明信息（tooltip），那么这些基础信息可以被节点文档面板直接获取，而无需再额外添加节点文档，你可以参考 [ContextWindowsManualNode](https://github.com/hanzoai/studio/blob/master/comfy_extras/nodes_context_windows.py#L7) 的相关实现。
