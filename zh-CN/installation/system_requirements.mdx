---
title: "系统要求"
description: "本文将介绍 Hanzo Studio 目前的一些系统要求，包括硬件及软件要求"
sidebarTitle: "系统要求"
icon: "computer"
---
...
在本篇我们将介绍安装 Hanzo Studio 的系统要求, 由于 Hanzo Studio 的更新频繁，本篇文档未必能够及时更新，请参考[Hanzo Studio](https://github.com/hanzoai/studio)中的相关说明。

无论是哪个版本的 Hanzo Studio，都是运行在一个独立的 Python 环境中。
...
请参考[Hanzo Studio Windows 和 Linux 手动安装章节](https://github.com/hanzoai/studio?tab=readme-ov-file#manual-install-windows-linux)了解详细的安装步骤。

你可以参考下面的章节来了解不同系统和版本 Hanzo Studio 的安装方式，在不同版本的安装中我们简单对安装的系统要求进行了说明。
...
为获得最佳体验，请使用 **Google Chrome 143 或更高版本**。Chrome 142 及更早版本存在已知问题，可能导致 Hanzo Studio 出现视觉故障和性能问题。
...
- 安装 Hanzo Studio 的 requirements.txt 中所有依赖：`pip install -r requirements.txt`
