---
title: "Hanzo Studio 文生图工作流"
description: "本篇将引导了解 AI 绘图中，文生图的概念，并在 Hanzo Studio 中完成文生图工作流生成"
sidebarTitle: "文生图"
---

import InstallationModels from '/snippets/zh/tutorials/basic/installation-models.mdx'

本篇目的主要带你初步了解 Hanzo Studio 的文生图的工作流，并初步了解一些 Hanzo Studio 相关节点的功能和使用。
...
请下载下面的图片，并将图片拖入 Hanzo Studio 的界面中，或者使用菜单 **工作流（Workflows）** -> **打开（Open）** 打开这个图片以加载对应的 workflow

![Hanzo Studio-文生图工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/basic/text-to-image-workflow.png)
...
整个文生图的过程，我们可以理解成是**扩散模型的反扩散过程**，我们下载的 [v1-5-pruned-emaonly-fp16.safetensors](https://huggingface.co/hanzoui/stable-diffusion-v1-5-archive/blob/main/v1-5-pruned-emaonly-fp16.safetensors) 是一个已经训练好的可以 **从纯高斯噪声生成目标图片的模型**，我们只需要输入我们的提示词，它就可以通随机的噪声降噪生成目标图片。
...
## Hanzo Studio 文生图工作流节点讲解

![Hanzo Studio 文生图工作流讲解](/images/tutorial/basic/text-image-workflow.jpg)
...
预览并保存从潜空间解码的图像，并保存到本地`Hanzo Studio/output`文件夹下
