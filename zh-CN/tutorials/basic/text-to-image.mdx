...
![HanzoStudio-文生图工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/basic/text-to-image-workflow.png)
...
预览并保存从潜空间解码的图像，并保存到本地`HanzoStudio/output`文件夹下
