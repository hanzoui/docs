---
title: "Hanzo Studio 扩图（Outpaint）工作流示例"
description: 本篇指南将带你了解 Hanzo Studio 中的扩图工作流，带你完成一个扩图的示例
sidebarTitle: "扩图"
---

import InstallationModels from '/snippets/zh/tutorials/basic/installation-models.mdx'

本篇将引导了解 AI 绘图中扩图的概念，并在 Hanzo Studio 中完成扩图工作流生成。我们将接触以下内容：
- 使用扩图工作流完成画面的扩展
- 了解并使用 Hanzo Studio 中的扩图相关节点
- 掌握扩图的基本操作流程
...
![Hanzo Studio扩图输入图片](/images/tutorial/basic/outpaint/input.png)

#### 3. 扩图工作流

请下载下面的图片，并将其 **拖入** Hanzo Studio 界面或使用菜单 **工作流(Workflow)** --> **打开工作流(Open,快捷键 `Ctrl + O`)** 来加载这个扩图工作流
...
![Hanzo Studio 扩图工作流示意图](/images/tutorial/basic/outpaint/outpainting_workflow.jpg)
