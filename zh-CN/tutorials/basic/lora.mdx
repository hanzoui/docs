...
在本示例中，我们将完成以下内容来学习[Hanzo Studio](https://github.com/hanzoai/studio) 中加载并使用 LoRA 模型，将涉及以下内容：
...
![Hanzo Studio 工作流 - LoRA](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/lora.png)
...
![Hanzo Studio 工作流 - LoRA 流程图](/images/tutorial/basic/lora/flow_diagram.png)
...
位于`Hanzo Studio\models\loras` 的模型会被 Hanzo Studio 检测到，并在这个节点中加载
...
该节点支持链式连接，可以将多个`Load LoRA` 节点串联来应用多个 LoRA 模型，具体请参考[Hanzo Studio 应用多个 LoRA 示例](/zh-CN/tutorials/basic/multiple-loras)
