---
title: "Hanzo Studio 图像放大工作流"
description: "本篇将引导了解 AI 绘图中，放大图片的概念，并在 Hanzo Studio 中完成放大图片工作流生成"
sidebarTitle: "图像放大"
---
...
当然本文介绍的只是诸多 Hanzo Studio 中图像放大方法中的一种，在这篇讲解中，我们将带你完成以下内容：
- 下载并安装放大模型
- 使用放大模型进行一次简单的放大
- 结合文生图工作流，完成图像的放大
...
![OpenModelDB_download](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/basic/upscale_workflow.png)

</Step>
<Step title="将模型文件放入指定目录">
将模型文件（.pth）放入 `Hanzo Studio\models\upscale_models` 目录
</Step>
</Steps>
...
请下载下面的图片，并拖入到 Hanzo Studio 中，加载简单版本放大工作流
![放大工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/basic/upscale_workflow.png)
...
请将下面的图片下载并保存后拖入到 Hanzo Studio 中，加载结合文生图的放大工作流
