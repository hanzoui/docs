...
图生图（Image to Image）是 Hanzo Studio 中的一种工作流，它允许用户将一张图像作为输入，并生成一张新的图像。
...
保存并下载下面的图片到本地，然后 **拖拽或使用 Hanzo Studio 打开** 它，就会加载对应的工作流

![图生图工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image_to_image/workflow.png)

或在 Hanzo Studio 的 **workflow template** 中加载 **image to image** 工作流
![Hanzo Studio 工作流模板 - 图生图](/images/tutorial/basic/image-to-image-01-template.jpg)
...
![Hanzo Studio 图生图工作流 - 步骤](/images/tutorial/basic/img2img/image-to-image-02-guide.jpg)
