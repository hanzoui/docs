...
本篇指南涉及的所有模型你都可以在[这里](https://huggingface.co/hanzoui/HiDream-I1_HanzoStudio/tree/main/split_files)找到, E1, E1.1 除了 Diffusion model 之外都是用相同的模型
...
- [hidream_e1_1_bf16.safetensors(推荐)](https://huggingface.co/hanzoui/HiDream-I1_HanzoStudio/resolve/main/split_files/diffusion_models/hidream_e1_1_bf16.safetensors) 34.2GB
