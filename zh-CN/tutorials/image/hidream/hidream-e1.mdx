---
title: "Hanzo Studio 原生版本 HiDream-E1, E1.1 工作流示例"
...
本篇指南涉及的所有模型你都可以在[这里](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/tree/main/split_files)找到, E1, E1.1 除了 Diffusion model 之外都是用相同的模型
...
- [hidream_e1_1_bf16.safetensors(推荐)](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/resolve/main/split_files/diffusion_models/hidream_e1_1_bf16.safetensors) 34.2GB
...
## HiDream E1.1 Hanzo Studio 原生工作流示例
...
下载下面的图片并拖入 Hanzo Studio 已加载对应工作流及模型
![HiDream E1.1 工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/hidream/e1.1/hidream_e1_1.png)

下载下面的图片作为输入
![HiDream E1.1 工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/hidream/e1.1/input.webp)
...
##  HiDream E1 Hanzo Studio 原生 工作流示例
...
请下载下面的图片并拖入 Hanzo Studio 中，工作流已包含模型下载信息，加载后将会提示你进行对应的模型下载。

![Hanzo Studio 原生 HiDream-e1 工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/hidream_e1/hidream_e1_full.png)

#### 1.2 下载输入图片

请下载下面的图片，我们将用于输入

![Hanzo Studio 原生 HiDream-e1 工作流 输入图片](https://raw.githubusercontent.com/hanzoui/example-workflows/main/hidream_e1/input.webp)
...
### Hanzo Studio HiDream-e1 工作流补充说明
