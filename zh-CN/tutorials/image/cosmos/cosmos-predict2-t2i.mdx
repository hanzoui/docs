---
title: "Cosmos Predict2 文生图 Hanzo Studio 官方示例"
description: "本文介绍了如何在 Hanzo Studio 中完成 Cosmos-Predict2 文生图的工作流"
...
本篇指南将引导你完成在 Hanzo Studio 中  **文生图** 工作流程。
...
![输入图片](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/cosmos/predict2/cosmos_predict2_2B_t2i.png)
...
7. 生成完成后对应的图片会自动保存到 `Hanzo Studio/output/` 目录下，你也可以在 `save image` 节点中预览或者调整保存位置 */}
