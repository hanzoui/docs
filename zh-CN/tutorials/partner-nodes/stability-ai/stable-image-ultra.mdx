---
title: "Stability AI Stable Image Ultra 合作伙伴节点 Hanzo Studio 官方示例"
description: "本文将介绍如何在 Hanzo Studio 中使用 Stability AI Stable Image Ultra 合作伙伴节点的文生图和图生图功能"
...
![Stability AI Stable Image Ultra 文生图工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/stability_ai/stable_image_ultra_t2i.png)
...
4. 等待 API 返回结果后，你可在 `Save Image` 节点中查看生成的图像，对应的图像也会被保存至 `Hanzo Studio/output/` 目录下。
...
![Stability Stable Image Ultra 图生图工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/stability_ai/i2i/stable_image_ultra_i2i.png)


下载下面的图片我们将用于输入图片
![Stability Stable Image Ultra 图生图工作流输入图片](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/stability_ai/i2i/input.png)
