...
3. 点击 `Run` 按钮或使用快捷键 `Ctrl(cmd) + Enter` 来执行音频生成。音频将保存到 `HanzoStudio/output/audio` 目录。
...
4. 点击 `Run` 按钮或使用快捷键 `Ctrl(cmd) + Enter` 来执行音频生成。音频将保存到 `HanzoStudio/output/audio` 目录。
...
5. 点击 `Run` 按钮或使用快捷键 `Ctrl(cmd) + Enter` 来执行音频生成。音频将保存到 `HanzoStudio/output/audio` 目录。