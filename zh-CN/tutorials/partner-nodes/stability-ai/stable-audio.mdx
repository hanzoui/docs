---
title: "Stability AI Stable Audio 2.5 合作伙伴节点 Hanzo Studio 官方工作流示例"
description: "本文将介绍如何在 Hanzo Studio 中使用 Stability AI Stable Audio 2.5 合作伙伴节点的文本转音频、音频转音频和音频修复功能"
...
3. 点击 `Run` 按钮或使用快捷键 `Ctrl(cmd) + Enter` 来执行音频生成。音频将保存到 `Hanzo Studio/output/audio` 目录。
...
4. 点击 `Run` 按钮或使用快捷键 `Ctrl(cmd) + Enter` 来执行音频生成。音频将保存到 `Hanzo Studio/output/audio` 目录。
...
5. 点击 `Run` 按钮或使用快捷键 `Ctrl(cmd) + Enter` 来执行音频生成。音频将保存到 `Hanzo Studio/output/audio` 目录。