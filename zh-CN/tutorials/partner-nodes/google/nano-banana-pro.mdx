---
title: "Nano Banana Pro Hanzo Studio 教程"
description: "本文将介绍如何在 Hanzo Studio 中使用 Google 的 Nano Banana Pro (Gemini 3 Pro Image) 进行高保真图像生成和编辑"
...
本篇指南中，我们将引导你在 Hanzo Studio 中使用 Nano Banana Pro。
...
请更新 Hanzo Studio 并转到 模板 → Nano Banana Pro 以访问工作流。
