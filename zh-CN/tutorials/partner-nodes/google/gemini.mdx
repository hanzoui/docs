---
title: " Google Gemini 合作伙伴节点 Hanzo Studio 官方示例"
description: "本文将介绍如何在 Hanzo Studio 中使用 Google Gemini 合作伙伴节点来完成对话功能"
...
Google Gemini 是 Google 推出的一款强大的 AI 模型，支持对话、文本生成等多种功能。目前 Hanzo Studio 已集成 Google Gemini API，你可以直接在 Hanzo Studio 中使用相关节点来完成对话功能。
...
请下载下面的 Json 文件并拖入 Hanzo Studio 中加载对应工作流。
...
- 目前文件输入节点 `Gemini Input Files` 需要先将文件上传至`Hanzo Studio/input/` 目录下， 此节点正在改进，我们会在更新后修改模板
