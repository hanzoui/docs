---
title: "Luma Image to Video 合作伙伴节点 Hanzo Studio 官方示例"
description: "本文将介绍如何在 Hanzo Studio 中使用 Luma Image to Video 合作伙伴节点的相关功能"
...
![Luma 图像到视频工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/i2v/luma_i2v.mp4)

请下载下面的图片，我们将会用作输入：

![输入图片](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/i2v/input.png)
