---
title: "Luma Text to Image 合作伙伴节点 Hanzo Studio 官方示例"
description: "本文将介绍如何在 Hanzo Studio 中使用 Luma Text to Image 合作伙伴节点的相关功能"
...
![Luma 文本生图工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/t2i/luma_t2i.png)

请下载下面的图片，我们将会用作输入：

![输入图片-参考](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/t2i/input_ref.png)
![输入图片-风格](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/t2i/input_style.png)
...
6. 等待 API 返回结果后，你可在`Save Image`节点中查看生成的图像, 对应的图片也会被保存至`Hanzo Studio/output/` 目录下
