---
title: "Luma Text to Video 合作伙伴节点 Hanzo Studio 官方示例"
description: "本文将介绍如何在 Hanzo Studio 中使用 Luma Text to Video 合作伙伴节点的相关功能"
...
![Luma 文本到视频工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/t2v/luma_t2v.mp4)
...
3. 等待 API 返回结果后，你可在 `Save Video` 节点中查看生成的视频，对应的视频也会被保存至 `Hanzo Studio/output/` 目录下
