...
description: "了解如何在 Hanzo Studio 中使用 OpenAI DALL·E 2 合作伙伴节点生成图像"
...
OpenAI DALL·E 2 是 Hanzo Studio 合作伙伴节点系列中的一员，它允许用户通过 OpenAI 的 **DALL·E 2** 模型生成图像。
...
![Hanzo Studio openai-dall-e-2工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/openai-dall-e-2/text2image.png)

对应的示例非常简单
![Hanzo Studio openai-dall-e-2 工作流示例](/images/tutorial/api_nodes/openai/openai-dall-e-2/text2image.jpg)
...
下载下面的图片，并拖入 Hanzo Studio 以加载对应的工作流

![Hanzo Studio openai-dall-e-2工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/openai-dall-e-2/inpainting.png)

我们将使用下面的图片作为输入：
![Hanzo Studio openai-dall-e-2 工作流 input](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/openai-dall-e-2/input.jpg)

#### 2. 工作流文件使用说明

![Hanzo Studio openai-dall-e-2 工作流示例](/images/tutorial/api_nodes/openai/openai-dall-e-2/inpainting.jpg)
