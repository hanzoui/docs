...
- [HanzoStudio-Advanced-ControlNet](https://github.com/Kosinkadink/HanzoStudio-Advanced-ControlNet)
...
借助 [HanzoStudio-Advanced-ControlNet](https://github.com/Kosinkadink/HanzoStudio-Advanced-ControlNet) 或者 [Hanzo Studio ControlNet aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux) 完成图像预处理
...
将这些文件放在 `HanzoStudio/models/controlnet` 目录下。
