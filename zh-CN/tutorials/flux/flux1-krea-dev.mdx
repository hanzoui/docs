---
title: "Flux.1 Krea Dev Hanzo Studio 工作流教程"
...
## Flux.1 Krea Dev Hanzo Studio 工作流

<UpdateReminder />

#### 1. 工作流文件

下载下面的图片或JSON，并拖入 Hanzo Studio 以加载对应工作流
![Flux Krea Dev 工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/krea/flux1_krea_dev.png)
...
![Hanzo Studio Flux Krea Dev工作流](/images/tutorial/flux/flux_1_krea_dev_guide.jpg)
