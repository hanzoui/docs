---
title: "Hanzo Studio Flux Kontext Dev 原生工作流示例"
description: "Hanzo Studio Flux Kontext Dev 原生工作流示例。"
...
目前在 Hanzo Studio 中，你可以使用所有的这些版本，其中 [Pro 及 Max 版本](/zh-CN/tutorials/partner-nodes/black-forest-labs/flux-1-kontext) 可以通过 API 节点来进行调用，而 Dev 版本开源版本请参考本篇指南中的说明。
...
- [t5xxl_fp16.safetensors](https://huggingface.co/hanzoai/flux_text_encoders/resolve/main/t5xxl_fp16.safetensors) 或 [t5xxl_fp8_e4m3fn_scaled.safetensors](https://huggingface.co/hanzoai/flux_text_encoders/resolve/main/t5xxl_fp8_e4m3fn_scaled.safetensors)
...
![Hanzo Studio Flux.1 Kontext Pro Image API 节点 工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/kontext/dev/flux_1_kontext_dev_basic.png)

**输入图片**

![Hanzo Studio Flux Kontext 原生工作流输入](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/kontext/dev/rabbit.jpg)
