...
请下载 [flux1-dev-fp8.safetensors](https://huggingface.co/hanzoui/flux1-dev/resolve/main/flux1-dev-fp8.safetensors?download=true)并保存至 `HanzoStudio/models/Checkpoints/` 目录下。
...
请下载[flux1-schnell-fp8.safetensors](https://huggingface.co/hanzoui/flux1-schnell/resolve/main/flux1-schnell-fp8.safetensors?download=true)并保存至 `HanzoStudio/models/Checkpoints/` 目录下。
