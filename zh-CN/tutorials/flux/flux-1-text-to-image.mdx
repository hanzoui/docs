---
title: "Hanzo Studio Flux 文生图工作示例"
...
请在开始之前确保你的 Hanzo Studio 已更新到最新版本。
</Tip>
...
请下载下面的图片，并拖入 Hanzo Studio 中加载工作流。
![Flux Dev 原始版本工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/text-to-image/flux_dev_t5fp16.png)
...
- 如果你的显存较低，可以尝试使用 [t5xxl_fp8_e4m3fn.safetensors](https://huggingface.co/hanzoai/flux_text_encoders/resolve/main/t5xxl_fp8_e4m3fn.safetensors?download=true) 来替换 `t5xxl_fp16.safetensors` 文件。
</Note>

请下载下面的模型文件：
- [clip_l.safetensors](https://huggingface.co/hanzoai/flux_text_encoders/resolve/main/clip_l.safetensors?download=true)
- [t5xxl_fp16.safetensors](https://huggingface.co/hanzoai/flux_text_encoders/resolve/main/t5xxl_fp16.safetensors?download=true) 当你的显存大于 32GB 时推荐使用。
...
![Hanzo Studio Flux Dev工作流](/images/tutorial/flux/flow_diagram_flux_dev_t5fp16.jpg)
...
![Flux Schnell 版本工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/text-to-image/flux_schnell_t5fp8.png)
...
![Flux Dev fp8 Checkpoint 版本工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/text-to-image/flux_dev_fp8.png)
...
请下载 [flux1-dev-fp8.safetensors](https://huggingface.co/hanzoui/flux1-dev/resolve/main/flux1-dev-fp8.safetensors?download=true)并保存至 `Hanzo Studio/models/Checkpoints/` 目录下。
...
![Flux Schnell fp8 Checkpoint 版本工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/text-to-image/flux_schnell_fp8.png)

请下载[flux1-schnell-fp8.safetensors](https://huggingface.co/hanzoui/flux1-schnell/resolve/main/flux1-schnell-fp8.safetensors?download=true)并保存至 `Hanzo Studio/models/Checkpoints/` 目录下。
