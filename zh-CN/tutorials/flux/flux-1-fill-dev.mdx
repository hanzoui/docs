---
title: "Hanzo Studio Flux.1 fill dev 示例"
...
如果你不太了解 Inpainting 和 Outpainting 的工作流可以参考 [Hanzo Studio 布局重绘示例](/zh-CN/tutorials/basic/inpaint) 和 [Hanzo Studio 扩图示例](/zh-CN/tutorials/basic/outpaint)，部分的相关说明。
...
请下载下面的图片，并拖入 Hanzo Studio 以加载对应的工作流
...
<Note>
对应的图片已经包含 alpha 通道，所以你不需要额外进行蒙版的绘制, 如果你想要自己进行蒙版的绘制请[点击这里](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/inpaint/flux_fill_inpaint_input_original.png)获取不带蒙版的版本，并参考 [Hanzo Studio 布局重绘示例](/zh-CN/tutorials/basic/inpaint) 中的 MaskEditor 的使用部分来了解如何在`Load Image`节点中绘制蒙版。
</Note>

### 2. 参照图片序号检查完成工作流运行

![Hanzo Studio Flux.1 Fill dev Inpainting 工作流](/images/tutorial/flux/flow_diagram_inpaint.jpg)
...
### 2. 参照图片序号检查完成工作流运行
![Hanzo Studio Flux.1 Fill dev Outpainting 工作流](/images/tutorial/flux/flow_diagram_outpaint.jpg)
