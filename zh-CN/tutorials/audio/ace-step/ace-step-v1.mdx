...
你也可以手动下载[ace_step_v1_3.5b.safetensors](https://huggingface.co/hanzoui/ACE-Step_HanzoStudio_repackaged/blob/main/all_in_one/ace_step_v1_3.5b.safetensors) 后保存到 `Hanzo Studio/models/checkpoints` 文件夹下
