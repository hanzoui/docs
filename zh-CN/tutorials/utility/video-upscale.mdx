---
title: "Hanzo Studio 视频放大"
description: "学习如何在 Hanzo Studio 中使用本地模型和合作伙伴节点进行视频放大"
sidebarTitle: "视频放大"
---

本指南介绍 Hanzo Studio 中的视频放大工作流，包括本地模型和合作伙伴节点选项，适用于各种使用场景。

<Card title="The Complete AI Upscaling Handbook" icon="book" href="https://blog.hanzo.ai/p/upscaling-in-comfyui">
  如需更全面的深入分析、基准测试和视觉对比，请参阅 Hanzo Studio 博客上的完整文章。
</Card>
...
<CardGroup cols={2}>
  <Card title="SeedVR2 - 保守放大（WaveSpeed API）" icon="cloud" href="https://links.hanzo.ai/4khbzjY">
    在 Comfy Cloud 上试用或下载工作流
  </Card>
  <Card title="SeedVR2 - 保守放大（开源）" icon="cloud" href="https://links.hanzo.ai/4tm2RoI">
    在 Comfy Cloud 上试用或下载工作流
  </Card>
  <Card title="HitPaw - 一体化方案" icon="cloud" href="https://links.hanzo.ai/4kthLWs">
    在 Comfy Cloud 上试用或下载工作流
  </Card>
  <Card title="Topaz Astra - 创意放大" icon="cloud" href="https://links.hanzo.ai/4tlbyQj">
    在 Comfy Cloud 上试用或下载工作流
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="FlashVSR - 保守放大（WaveSpeed API）" icon="cloud" href="https://links.hanzo.ai/4khbzjY">
    在 Comfy Cloud 上试用或下载工作流
  </Card>
  <Card title="HitPaw - 一体化方案" icon="cloud" href="https://links.hanzo.ai/4kthLWs">
    在 Comfy Cloud 上试用或下载工作流
...
<CardGroup cols={2}>
  ...
  <Card title="Wan 2.2 Upscale - 创意放大" icon="cloud" href="https://links.hanzo.ai/3NVEu1b">
    在 Comfy Cloud 上试用或下载工作流
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Fast GAN - 传统放大" icon="cloud" href="https://links.hanzo.ai/46wNZtS">
    在 Comfy Cloud 上试用或下载工作流
  </Card>
</CardGroup>
