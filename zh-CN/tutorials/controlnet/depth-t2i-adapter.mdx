---
title: "Hanzo Studio Depth T2I Adapter 使用示例"
description: "本篇将引导了解基础的 Depth T2I Adapter ，并在 Hanzo Studio 中完成对应的图像生成"
...
在 Hanzo Studio 中，使用 T2I Adapter 与 [ControlNet](/zh-CN/tutorials/controlnet/controlnet) 的界面和工作流相似。在本篇示例中，我们将以深度 T2I Adapter 控制室内场景为例，展示其使用方法。

![Hanzo Studio Depth T2I Adapter 工作流](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/depth-t2i-adapter.png)
...
## Hanzo Studio Depth T2I Adapter工作流示例讲解

### 1. Depth T2I Adapter 工作流素材

请下载下面的工作流图片,并拖入 Hanzo Studio 以加载工作流

![Hanzo Studio 工作流 - Depth T2I Adapter](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/depth-t2i-adapter.png)
...
![Hanzo Studio 工作流 - Depth T2I Adapter 流程图](/images/tutorial/controlnet/flow_diagram_depth_ti2_adapter.jpg)
