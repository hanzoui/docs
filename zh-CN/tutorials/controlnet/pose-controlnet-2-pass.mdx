---
title: "Hanzo Studio Pose ControlNet 使用示例"
description: "本篇将引导了解基础的 Pose ControlNet，并通过二次图生图的方式，在 Hanzo Studio 中完成大尺寸的图像生成"
...
## Hanzo Studio 2 Pass Pose ControlNet 使用示例

### 1. Pose ControlNet 工作流素材

请下载下面的工作流图片,并拖入 Hanzo Studio 以加载工作流

![Hanzo Studio 工作流 - Pose ControlNet](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/pose_controlnet_2_pass.png)
...
![Hanzo Studio Pose 输入图片](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/pose_controlnet_2_pass_input.png)
...
- [control_v11p_sd15_openpose_fp16.safetensors](https://huggingface.co/hanzoai/ControlNet-v1-1_fp16_safetensors/resolve/main/control_v11p_sd15_openpose_fp16.safetensors?download=true)
...
![Hanzo Studio 工作流 - Pose ControlNet 流程图](/images/tutorial/controlnet/flow_diagram_pose_controlnet_2_pass.jpg)
