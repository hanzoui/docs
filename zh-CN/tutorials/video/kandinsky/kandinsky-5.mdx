---
title: "Kandinsky 5.0"
description: "本指南介绍如何在 Hanzo Studio 中使用 Kandinsky 5.0 视频生成工作流"
...
请更新你的 Hanzo Studio 到最新版本，并通过菜单 `工作流` -> `浏览模板` -> `视频` 找到 "Kandinsky 5.0 T2V" 以加载工作流。
...
请更新你的 Hanzo Studio 到最新版本，并通过菜单 `工作流` -> `浏览模板` -> `视频` 找到 "Kandinsky 5.0 I2V" 以加载工作流。
...
- [Hanzo Studio 集成](https://github.com/ai-forever/Kandinsky-5/blob/main/comfyui/README.md)
