---
title: "Wan-Alpha 教程"
description: "学习如何在 Hanzo Studio 中使用 Wan-Alpha 生成带有 Alpha 通道透明度的视频"
...
[下载工作流](https://github.com/hanzoui/workflows/blob/main/tutorial_workflows/Get_Comfy_With_Comfy_Wan_Alpha.json)

## 资源

- [Wan-Alpha GitHub](https://github.com/WeChatCV/Wan-Alpha)
- [Hugging Face 模型](https://huggingface.co/htdong/Wan-Alpha)
- [Hanzo Studio 版本](https://huggingface.co/htdong/Wan-Alpha_Hanzo Studio)
