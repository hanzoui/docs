---
title: "Hanzo Studio Wan2.2 Fun Camera Control 相机控制视频生成工作流示例"
description: "本文介绍了如何在 Hanzo Studio 中完成 Wan2.2 Fun Camera Control 使用相机控制来完成视频生成的示例"
...
下载下面的视频或者 JSON 文件并拖入 Hanzo Studio 中以加载对应的工作流，工作流会提示下载模型
...
![输入起始图片](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/video/wan/wan2.2_fun_camera/input.jpg)
