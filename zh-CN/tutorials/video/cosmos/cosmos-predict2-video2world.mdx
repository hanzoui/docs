---
title: "Cosmos Predict2 视频生成 Hanzo Studio 官方示例"
description: "本文介绍了如何在 Hanzo Studio 中完成 Cosmos-Predict2 文生视频及图生视频的工作流"
...
本篇指南将引导你完成在 Hanzo Studio 中  **图生视频** 的工作流
...
![输入图片](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/video/cosmos/predict2/input.png)
...
其它权重请访问 [Cosmos_Predict2_repackaged](https://huggingface.co/hanzoui/Cosmos_Predict2_repackaged) 进行下载
...
9. 生成完成后对应的视频会自动保存到 `Hanzo Studio/output/` 目录下，你也可以在 `save video` 节点中预览或者调整保存位置 */}
