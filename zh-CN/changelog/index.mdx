---
title: "更新日志"
description: "跟踪 Hanzo Studio 的最新功能、改进和错误修复。详细发布说明请查看 [Github 发布页面](https://github.com/hanzoai/studio/releases)。"
...
- 修复 fp8 处理问题
- 修复 MPO 格式图像只使用第一帧
- 根据 PyTorch 版本条件性支持 hanzo-kitchen CUDA

**其他**
- 新增 OOM 内存摘要用于调试
- Mahiro CFG 显示名称更新
- 工作流模板更新至 v0.7.67
- 代码重构与清理（CLIP 预处理、hanzo-kitchen 集成）
</Update>
...
**版本更新**
- Hanzo Frontend 更新至 v1.35.9
- Hanzo Manager 更新至 v4.0.4
- 工作流模板更新至 v0.7.64
...
- 请从[这里](https://hanzo.ai/download)下载最新的桌面版本以获取最新功能。
...
**LoRA 训练器**
- Hanzo Studio 原生 LoRA 训练器支持多分辨率
- 支持 Z-Image LoRA 训练
...
**API 节点扩展**
- **新增 Topaz API 节点**：在 Hanzo Studio 中直接添加了对 Topaz 视频增强工作流的支持
...
**API 节点**
- **Rodin3D Gen-2**：Rodin 最强大的图像转3D工具现已在 Hanzo Studio 中上线！
...
此次专项更新改进了支撑 Hanzo Studio 灵活架构的核心节点模型补丁系统：

**核心基础设施增强**
- **节点模型补丁更新**：增强了 nodes_model_patch.py，改进了底层模型补丁机制，使得 Hanzo Studio 对 Qwen-Image ControlNet 的扩展更为容易
...
此版本增加了 Hanzo Studio 的音频处理能力，并包含性能改进和模型兼容性更新：
...
此版本显著扩展了 ControlNet 功能并改进了模型兼容性，让 Hanzo Studio 工作流更加多样化和可靠：
...
**平台和开发改进**
- **Python 3.13 支持**：完全兼容 Python 3.13，保持 Hanzo Studio 与最新 Python 发展同步
...
**多媒体节点支持**
- **音频录制节点**：新增原生音频录制节点，现在你可以直接在 Hanzo Studio内录制音频
- **音频视频集成**：完善音频-视频依赖项集成
...
本次更新扩展了Hanzo Studio的模型支持，优化了API功能，并提升了工作流程的稳定性：
