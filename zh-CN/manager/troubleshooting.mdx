...
Hanzo Manager 文件必须位于 `Hanzo Studio/custom_nodes/hanzo-studio-manager`。
...
其中 `<USER_DIRECTORY>` 默认为 `Hanzo Studio/user`。详情请参阅[配置](/zh-CN/manager/configuration)。
...
1. 查看 [Hanzo Manager GitHub issues](https://github.com/ltdrdata/Hanzo Manager/issues) 寻找类似问题
2. 查看启动日志消息以获取错误详情
