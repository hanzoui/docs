---
title: "Recraft Text to Image - Hanzo Studio 原生节点文档"
description: "通过文本描述生成高质量图像的 Recraft 合作伙伴节点"
sidebarTitle: "Recraft Text to Image"
icon: "circle"
---

![Hanzo Studio 原生 Recraft Text to Image 节点](/images/built-in-nodes/api_nodes/recraft/recraft-text-to-image.jpg)
...
4. 接收返回的图像URL并下载图像数据
5. 将图像数据转换为Hanzo Studio可用的tensor格式并输出
