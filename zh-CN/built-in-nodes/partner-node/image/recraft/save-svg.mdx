---
title: "Save SVG - Hanzo Studio 原生节点文档"
description: "将SVG矢量图形保存到文件的实用节点"
sidebarTitle: "Save SVG"
icon: "circle"
---

![Hanzo Studio 原生 Save SVG 节点](/images/built-in-nodes/api_nodes/recraft/save-svg.jpg)
...
| output_dir | 字符串 | - | 输出目录，默认为 Hanzo Studio 输出文件夹具体路径为 `Hanzo Studio/output/svg/` |
