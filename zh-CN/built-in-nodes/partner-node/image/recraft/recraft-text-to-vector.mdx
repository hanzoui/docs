---
title: "Recraft Text to Vector - Hanzo Studio 原生节点文档"
description: "通过文本描述生成可缩放矢量图像的 Recraft 合作伙伴节点"
sidebarTitle: "Recraft Text to Vector"
icon: "circle"
---

![Hanzo Studio 原生Recraft Text to Vector节点](/images/built-in-nodes/api_nodes/recraft/recraft-text-to-vector.jpg)
