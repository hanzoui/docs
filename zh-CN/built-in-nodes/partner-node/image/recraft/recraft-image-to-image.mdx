---
title: "Recraft Image to Image - Hanzo Studio 原生节点文档"
description: "通过文本描述和参考图像生成新图像的 Recraft 合作伙伴节点"
sidebarTitle: "Recraft Image to Image"
icon: "circle"
---

![Hanzo Studio 原生Recraft Image to Image节点](/images/built-in-nodes/api_nodes/recraft/recraft-image-to-image.jpg)
