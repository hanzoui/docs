---
title: "Flux 1.1 [pro] Ultra Image - Hanzo Studio 原生节点文档"
description: "使用 Black Forest Labs 的高分辨率图像生成 API 创建图像"
sidebarTitle: "Flux 1.1 [pro] Ultra Image"
icon: "circle"
---

![Hanzo Studio 原生 Flux 1.1 [pro] Ultra Image 节点](/images/built-in-nodes/api_nodes/bfl/flux-1-1-pro-ultra-image.jpg)
...
- [Flux 1.1 Pro Ultra Image 合作伙伴节点 Hanzo Studio 官方示例工作流](/zh-CN/tutorials/partner-nodes/black-forest-labs/flux-1-1-pro-ultra-image)
