...
description: "了解如何在 Hanzo Studio 中访问节点的内置文档,包括内置节点和自定义节点。"
sidebarTitle: "节点文档"
icon: "book-open"
---

节点文档提供了快速访问工作流中任何节点文档的功能。您可以直接在 Hanzo Studio 中查看有关节点功能、参数和使用示例的详细信息。
...
Hanzo Studio 内置节点的文档维护在 [embedded-docs 仓库](https://github.com/hanzoui/embedded-docs)中。

**为内置节点文档做贡献:**
- 用户可以为内置节点文档贡献改进和补充
- 向 [embedded-docs 仓库](https://github.com/hanzoui/embedded-docs)提交拉取请求
- 帮助改善整个 Hanzo Studio 社区的文档质量
