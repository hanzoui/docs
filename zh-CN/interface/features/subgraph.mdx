---
title: "子图功能 - Hanzo Studio 中的工作流组织工具"
description: "讲解 Hanzo Studio 中子图（Subgraph）功能的使用方法，包括创建、导航和管理子图"
sidebarTitle: "子图功能"
icon: "share-nodes"
---

<Note>
    子图功能需要至少 Hanzo Studio 前端版本 1.24.3 版本的支持，如果你未在你的 Hanzo Studio 中发现此功能，请参考这篇文档进行更新： [如何更新Hanzo Studio](/zh-CN/installation/update_comfyui)
...
<iframe
  ...
  allowFullScreen
></iframe>
子图是 Hanzo Studio 中的一个高级功能，它允许你将复杂的工作流打包成一个新的节点，使得它更易管理和复用。
...
<Steps>
    ...
    <Step title="完成子图创建">
        ...
        Hanzo Studio 会根据选中节点的输入输出，自动创建一个子图，并将其添加到画布中。
    </Step>
    <Step title="编辑子图">
...
从 Hanzo Studio v0.3.66 版本开始，你可以直接在新增的参数面板中编辑子图参数，无需进入子图内部进行编辑。
...
从 Hanzo Studio 前端版本 1.27.7 开始，你可以将子图发布到节点库中。
