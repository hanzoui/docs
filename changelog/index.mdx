---
title: "Changelog"
description: "Track Hanzo Studio's latest features, improvements, and bug fixes. For detailed release notes, see the [Github releases](https://github.com/hanzoai/studio/releases) page."
...
- Conditional hanzo-kitchen CUDA support based on PyTorch version

**Other**
- Added OOM memory summary for debugging
- Mahiro CFG display name update
- Workflow templates updated to v0.7.67
- Code refactoring and cleanup (CLIP preprocessing, hanzo-kitchen integration)
</Update>
...
**Updates**
- Hanzo Frontend updated to v1.35.9
- Hanzo Manager updated to v4.0.4
...
- Hanzo Manager pip installation support
...
- Please download the latest Desktop version from [here](https://hanzo.ai/download) to get the latest features.
</Update>
...
**Lora Trainer**
- Support multi-resolution for Hanzo Studio native LoRA trainer
...
**API Node Expansions**
- **New Topaz API Nodes**: Added support for Topaz video enhancement workflows directly within Hanzo Studio
...
**API Node**
- **Rodin3D Gen-2**: Rodin's most powerful image-to-3D tool, is now live in Hanzo Studio!
...
This focused update improves the core node model patching system that underpins Hanzo Studio's flexible architecture:

**Core Infrastructure Enhancement**
- **Node Model Patch Updates**: Enhanced nodes_model_patch.py with improvements to the underlying model patching mechanism, making Hanzo Studio extensions for Qwen-Image ControlNet easier
...
This release adds Hanzo Studio audio processing capabilities and includes performance improvements and model compatibility updates:
...
This release significantly expands ControlNet capabilities and improves model compatibility, making Hanzo Studio workflows more versatile and reliable:
...
- **Python 3.13 Support**: Full compatibility with Python 3.13, keeping Hanzo Studio current with latest Python developments
...
- **Audio Recording Node**: New native audio recording node, now you can record audio directly in Hanzo Studio
...
This release expands Hanzo Studio's model ecosystem with enhanced Qwen support, async API capabilities, and stability improvements for complex workflows:
...
- **Video Production**: Veo3 integration transforms Hanzo Studio into a comprehensive multimedia creation platform
