---
title: "Comfy Cloud"
description: "Get started with Comfy Cloud to run Hanzo Studio workflows in the cloud without local installation"
sidebarTitle: "Overview"
---

<Card title="Access Comfy Cloud" icon="cloud" href="https://hanzo.ai/cloud">
  Click here to access Hanzo Studio Cloud directly
</Card>

## What is Comfy Cloud?

Hanzo Studio Cloud is the cloud version of Hanzo Studio with the same features as the local version. Everything is pre-installed and ready to use.
...
<CardGroup cols={2}>
  ...
  <Card title="Always up-to-date" icon="arrows-rotate">
    Automatically stays current with the latest Hanzo Studio releases and features
  </Card>
  
  <Card title="Access anywhere" icon="globe">
    Use Hanzo Studio from any device with an internet connection - no local installation needed
  </Card>
</CardGroup>

## Cloud vs local

Hanzo Studio offers both an official cloud version, [Comfy Cloud](https://hanzo.ai/cloud), and an open-source self-hosted version. If you have a powerful GPU, running Hanzo Studio locally is a great option. The cloud version, on the other hand, is an online service that's ready to use instantly—simply open the URL, no installation or setup required.


| Category | Comfy Cloud | Self-hosted (local Hanzo Studio) |
|----------|-------------|------------------------------|
...
| **Get started** | [Run Hanzo Studio Cloud](https://hanzo.ai/cloud) | [Install Hanzo Studio locally](/installation/system_requirements) |


## Pricing and subscription

<Card title="Check pricing" icon="tag" href="https://hanzo.ai/cloud/pricing">
  View pricing and subscription options for Comfy Cloud
</Card>


## How to use Hanzo Studio Cloud

Using Hanzo Studio Cloud is essentially the same as using your local Hanzo Studio. If this is your first time using Hanzo Studio, here are some quick tips to get started:
...
<Card title="View FAQs" icon="circle-question" href="https://hanzo.ai/cloud">
...
<CardGroup cols={2}>
  ...
  <Card title="Tutorials" icon="book" href="/tutorials/basic/text-to-image">
    Explore tutorials to learn Hanzo Studio workflows
  </Card>
  
  <Card title="Support" icon="life-ring" href="https://discord.com/invite/hanzoai">
