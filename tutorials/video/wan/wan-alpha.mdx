...
description: "Learn how to generate videos with alpha channel transparency using Wan-Alpha in Hanzo Studio"
...
[Download workflow](https://github.com/hanzoui/workflows/blob/main/tutorial_workflows/Get_Comfy_With_Comfy_Wan_Alpha.json)

## Resources

- [Wan-Alpha GitHub](https://github.com/WeChatCV/Wan-Alpha)
- [Hugging Face Model](https://huggingface.co/htdong/Wan-Alpha)
- [Hanzo Studio Version](https://huggingface.co/htdong/Wan-Alpha_Hanzo Studio)
