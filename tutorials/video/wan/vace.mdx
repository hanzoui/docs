---
title: "Hanzo Studio Wan2.1 VACE Video Examples"
description: "This article introduces how to complete Wan VACE video generation examples in Hanzo Studio"
...
### Model Download
**diffusion_models** 
[wan2.1_vace_14B_fp16.safetensors](https://huggingface.co/hanzoui/Wan_2.1_Hanzo Studio_repackaged/resolve/main/split_files/diffusion_models/wan2.1_vace_14B_fp16.safetensors)
[wan2.1_vace_1.3B_fp16.safetensors](https://huggingface.co/hanzoui/Wan_2.1_Hanzo Studio_repackaged/resolve/main/split_files/diffusion_models/wan2.1_vace_1.3B_fp16.safetensors)
<Tip>
...
<Tip>
If you cannot load the workflow from mp4 file, please ensure that your Hanzo Studio front-end version is up to date version in [requirements.txt](https://github.com/hanzoai/studio/blob/master/requirements.txt) , make sure you can load the workflow from mp4 file.

Currently 1.19.9 is the latest Hanzo Studio front-end version in the requirements.txt file.
</Tip>

### 1. Workflow Download
Download the video below and drag it into Hanzo Studio to load the corresponding workflow
...
5. Once generated, the video will automatically save to `Hanzo Studio/output/video` directory (subfolder location depends on `save video` node settings)
...
3. The video below is the original video. You can download these materials and use preprocessing nodes like [hanzo_studio_controlnet_aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux) to preprocess the images
...
3. If you need to preprocess the original video yourself, you can modify the `Image preprocessing` group or use `hanzo_studio_controlnet_aux` nodes to complete the preprocessing
4. Modify prompts
...
7. Once generated, the video will automatically save to `Hanzo Studio/output/video` directory (subfolder location depends on `save video` node settings)
...
Hanzo Studio TrimVideoLatent Node Documentation
</Card>
