...
5. Once generated, the video will automatically save to `HanzoStudio/output/video` directory (subfolder location depends on `save video` node settings)
...
7. Once generated, the video will automatically save to `HanzoStudio/output/video` directory (subfolder location depends on `save video` node settings)
