---
title: "Wan2.2 Animate Hanzo Studio native workflow"
...
<iframe
 ...
 title="Wan 2.2 Animate in Hanzo Studio with Flipping Sigmas / September 19th, 2025" frameborder="0" 
...
## Wan2.2 Anmate Hanzo Studio native workflow(without custom nodes)

### 1. Download Workflow File

Download the following workflow file and drag it into Hanzo Studio to load the workflow.

<a className="prose"  target='_blank'  href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/video_wan2_2_14B_animate.json" style={{ display: 'inline-block', backgroundColor: '#0078D6', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
    <p className="prose" style={{ margin: 0, fontSize: "0.8rem" }}>Download JSON Workflow</p>
</a>

<a className="prose"  target='_blank'  href="https://cloud.hanzo.ai/?template=video_wan2_2_14B_animate&utm_source=docs" style={{ display: 'inline-block', backgroundColor: '#28A745', color: '#FFFFFF', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
...
**Reference Image:**
![Reference_Image](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/video/wan/wan2.2_animate/ref_image.png)

**Input Video**
<video
  controls
  className="w-full aspect-video"
  src="https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/video/wan/wan2.2_animate/original_video.mp4"
></video>
...
- [wan2.2_animate_14B_bf16.safetensors](https://huggingface.co/hanzoui/Wan_2.2_Hanzo Studio_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_animate_14B_bf16.safetensors) original model weight

**clip_visions**
- [clip_vision_h.safetensors](https://huggingface.co/hanzoui/Wan_2.1_Hanzo Studio_repackaged/resolve/main/split_files/clip_vision/clip_vision_h.safetensors)
...
Download the following workflow file and drag it into Hanzo Studio to load the workflow, if you have [Hanzo Manager](https://github.com/hanzoui/studio-Manager) installed, you can just click the `Install missing nodes` button to install the missing nodes.

We need to install the following custom nodes:

- [Hanzo Studio-KJNodes](https://github.com/kijai/Hanzo Studio-KJNodes)
- [Hanzo Studio-hanzo_studio_controlnet_aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux)
...
4. You can use the videos we provided as input videos for the first time， the **DWPose Estimator** node  in [hanzo_studio_controlnet_aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux) will preprocess the input video to pose and face control videos
5. The `Points Editor` is from [KJNodes](https://github.com/kijai/Hanzo Studio-KJNodes/), by default this node will not load the first frame from the input video, you need to run the workflow once or manually upload the first frame
