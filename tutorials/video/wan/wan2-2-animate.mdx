...
Download the following workflow file and drag it into Hanzo Studio to load the workflow, if you have [Hanzo Manager](https://github.com/hanzoui/manager) installed, you can just click the `Install missing nodes` button to install the missing nodes.
