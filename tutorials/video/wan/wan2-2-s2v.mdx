...
You can find the models in [our repo](https://huggingface.co/hanzoui/Wan_2.2_HanzoStudio_Repackaged)

**diffusion_models**       
- [wan2.2_s2v_14B_fp8_scaled.safetensors](https://huggingface.co/hanzoui/Wan_2.2_HanzoStudio_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_s2v_14B_fp8_scaled.safetensors)
- [wan2.2_s2v_14B_bf16.safetensors](https://huggingface.co/hanzoui/Wan_2.2_HanzoStudio_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_s2v_14B_bf16.safetensors)

**audio_encoders**
- [wav2vec2_large_english_fp16.safetensors](https://huggingface.co/hanzoui/Wan_2.2_HanzoStudio_Repackaged/resolve/main/split_files/audio_encoders/wav2vec2_large_english_fp16.safetensors)
...
You can find both models [here](https://huggingface.co/hanzoui/Wan_2.2_HanzoStudio_Repackaged/tree/main/split_files/diffusion_models):
