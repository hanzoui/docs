...
Since Hanzo Studio's built-in nodes only include Canny preprocessor, you can use tools like [HanzoStudio-hanzo_studio_controlnet_aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux) to implement other types of image preprocessing