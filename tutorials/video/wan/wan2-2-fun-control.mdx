---
title: "Hanzo Studio Wan2.2 Fun Control Video Generation Example"
description: "This article introduces how to use Hanzo Studio to complete the Wan2.2 Fun Control video generation using control videos"
...
Download the video below or JSON file and drag it into Hanzo Studio to load the workflow

<video
  controls
  className="w-full aspect-video"
  src="https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/video/wan/wan2.2_fun_control/wan2.2_14B_fun_inp.mp4"
></video>

<a className="prose"  target='_blank'  href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/video_wan2_2_14B_fun_control.json" style={{ display: 'inline-block', backgroundColor: '#0078D6', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
...
![Input start image](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/video/wan/wan2.2_fun_control/input.jpg)

<video
  controls
  className="w-full aspect-video"
  src="https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/video/wan/wan2.2_fun_control/control_video.mp4"
></video>
...
You can find the models below at [Wan_2.2_Hanzo Studio_Repackaged](https://huggingface.co/hanzoui/Wan_2.2_Hanzo Studio_Repackaged)

**Diffusion Model**
- [wan2.2_fun_control_high_noise_14B_fp8_scaled.safetensors](https://huggingface.co/hanzoui/Wan_2.2_Hanzo Studio_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_fun_control_high_noise_14B_fp8_scaled.safetensors)
- [wan2.2_fun_control_low_noise_14B_fp8_scaled.safetensors](https://huggingface.co/hanzoui/Wan_2.2_Hanzo Studio_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_fun_control_low_noise_14B_fp8_scaled.safetensors)
...
Since Hanzo Studio's built-in nodes only include Canny preprocessor, you can use tools like [Hanzo Studio-hanzo_studio_controlnet_aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux) to implement other types of image preprocessing