...
You can find the models below at [Wan_2.2_HanzoStudio_Repackaged](https://huggingface.co/hanzoui/Wan_2.2_HanzoStudio_Repackaged)

**Diffusion Model**
- [wan2.2_fun_control_high_noise_14B_fp8_scaled.safetensors](https://huggingface.co/hanzoui/Wan_2.2_HanzoStudio_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_fun_control_high_noise_14B_fp8_scaled.safetensors)
- [wan2.2_fun_control_low_noise_14B_fp8_scaled.safetensors](https://huggingface.co/hanzoui/Wan_2.2_HanzoStudio_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_fun_control_low_noise_14B_fp8_scaled.safetensors)
