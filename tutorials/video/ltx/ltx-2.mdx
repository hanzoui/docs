...
LTX-2 is natively supported in Hanzo Studio. To get started:

1. Update Hanzo Studio to the latest version
...
<CardGroup cols={2}>
  <Card title="Text-to-Video" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/video_ltx2_t2v.json">
    Download workflow
  </Card>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.hanzo.ai/?template=video_ltx2_t2v&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>

**Distilled version** (faster, 8 steps):
<Card title="Text-to-Video Distilled" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/video_ltx2_t2v_distilled.json">
  Download workflow
</Card>
...
<CardGroup cols={2}>
  <Card title="Image-to-Video" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/video_ltx2_i2v.json">
    Download workflow
  </Card>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.hanzo.ai/?template=video_ltx2_i2v&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>

**Distilled version** (faster, 8 steps):
<Card title="Image-to-Video Distilled" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/video_ltx2_i2v_distilled.json">
  Download workflow
</Card>
...
**Depth control:**
<CardGroup cols={2}>
  <Card title="Depth-to-Video" icon="download" href="https://github.com/hanzoui/workflow-templates/raw/refs/heads/main/templates/video_ltx2_depth_to_video.json">
    Download workflow
  </Card>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.hanzo.ai/?template=video_ltx2_depth_to_video&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>
...
**Canny control:**
<CardGroup cols={2}>
  <Card title="Canny-to-Video" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/video_ltx2_canny_to_video.json">
    Download workflow
  </Card>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.hanzo.ai/?template=video_ltx2_canny_to_video&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>
...
**Pose control:**
<CardGroup cols={2}>
  <Card title="Pose-to-Video" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/video_ltx2_pose_to_video.json">
    Download workflow
  </Card>
  <Card title="Run on Comfy Cloud" icon="cloud" href="https://cloud.hanzo.ai/?template=video_ltx2_pose_to_video&utm_source=docs&utm_campaign=ltx_2">
    Open in cloud
  </Card>
</CardGroup>
...
- [Hanzo Studio-LTXVideo](https://github.com/Lightricks/Hanzo Studio-LTXVideo/)
