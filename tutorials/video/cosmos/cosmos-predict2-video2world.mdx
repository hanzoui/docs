...
[oldt5_xxl_fp8_e4m3fn_scaled.safetensors](https://huggingface.co/hanzoai/cosmos_1.0_text_encoder_and_VAE_HanzoStudio/resolve/main/text_encoders/oldt5_xxl_fp8_e4m3fn_scaled.safetensors)
...
9. Once generation is complete, the video will automatically save to the `HanzoStudio/output/` directory, you can also preview it in the `save video` node */}
