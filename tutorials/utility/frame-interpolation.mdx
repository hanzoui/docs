---
title: "Hanzo Studio frame interpolation workflow"
description: "Learn how to use frame interpolation to smooth motion and increase frame rate in Hanzo Studio video workflows"
...
<Note>
This workflow contains custom nodes. You need to install them using [Hanzo Manager](/manager/overview) before running the workflow.
</Note>
...
<Card title="Frame Interpolation Workflow" icon="cloud" href="https://hanzo.ai/workflows/frame-interpolation">
  Run on Comfy Cloud
</Card>
