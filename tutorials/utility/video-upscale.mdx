---
title: "Video upscaling in Hanzo Studio"
description: "Learn how to upscale videos in Hanzo Studio using local models and partner nodes for different use cases"
sidebarTitle: "Video upscale"
---

This guide covers video upscaling workflows in Hanzo Studio, including local models and partner node options for various use cases.

<Card title="The Complete AI Upscaling Handbook" icon="book" href="https://blog.hanzo.ai/p/upscaling-in-comfyui">
  For a comprehensive deep-dive with benchmarks and visual comparisons, see the full article on the Hanzo Studio Blog.
</Card>
...
<CardGroup cols={2}>
  <Card title="SeedVR2 - Conservative (WaveSpeed API)" icon="cloud" href="https://links.hanzo.ai/4khbzjY">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="SeedVR2 - Conservative (Open Source)" icon="cloud" href="https://links.hanzo.ai/4tm2RoI">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="HitPaw - All-in-one" icon="cloud" href="https://links.hanzo.ai/4kthLWs">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="Topaz Astra - Creative" icon="cloud" href="https://links.hanzo.ai/4tlbyQj">
    Try on Comfy Cloud or download workflow
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="FlashVSR - Conservative (WaveSpeed API)" icon="cloud" href="https://links.hanzo.ai/4khbzjY">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="HitPaw - All-in-one" icon="cloud" href="https://links.hanzo.ai/4kthLWs">
    Try on Comfy Cloud or download workflow
...
<CardGroup cols={2}>
  ...
  <Card title="Wan 2.2 Upscale - Creative" icon="cloud" href="https://links.hanzo.ai/3NVEu1b">
    Try on Comfy Cloud or download workflow
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Fast GAN - Traditional" icon="cloud" href="https://links.hanzo.ai/46wNZtS">
    Try on Comfy Cloud or download workflow
  </Card>
</CardGroup>
