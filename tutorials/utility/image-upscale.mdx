---
title: "Image upscaling in Hanzo Studio"
description: "Learn how to upscale images in Hanzo Studio using local models and partner nodes for different use cases"
sidebarTitle: "Image upscale"
---

This guide covers image upscaling workflows in Hanzo Studio, including local models and partner node options for various use cases.

<Card title="The Complete AI Upscaling Handbook" icon="book-open" href="https://blog.hanzo.ai/p/upscaling-in-comfyui">
  For a comprehensive deep-dive with benchmarks and visual comparisons, read the full article on the Hanzo Studio Blog.
</Card>
...
<CardGroup cols={2}>
  <Card title="Magnific Skin Enhancer" icon="cloud" href="https://links.hanzo.ai/4cbvbE7">
...
<CardGroup cols={2}>
  <Card title="HitPaw" icon="cloud" href="https://links.hanzo.ai/4kkoula">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="Nano Banana Pro Product" icon="cloud" href="https://links.hanzo.ai/4qUntD0">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="SeedVR2 (Open Source)" icon="cloud" href="https://links.hanzo.ai/4ko2sOG">
    Try on Comfy Cloud or download workflow
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Topaz Landscape" icon="cloud" href="https://links.hanzo.ai/4r1utxS">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="Recraft Creative" icon="cloud" href="https://links.hanzo.ai/4afKfOJ">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="Recraft Crisp" icon="cloud" href="https://links.hanzo.ai/3O0M4Yf">
    Try on Comfy Cloud or download workflow
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Topaz Illustration" icon="cloud" href="https://links.hanzo.ai/46zi8c1">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="Topaz Creative" icon="cloud" href="https://links.hanzo.ai/4kjT12P">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="Nano Banana Pro Styled Art" icon="cloud" href="https://links.hanzo.ai/3O0Maiz">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="Nano Banana Pro Portrait" icon="cloud" href="https://links.hanzo.ai/3O9XtF7">
    Try on Comfy Cloud or download workflow
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Traditional Non-AI Upscaling" icon="cloud" href="https://links.hanzo.ai/45Nu9um">
    Try on Comfy Cloud or download workflow
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="HitPaw Creative" icon="cloud" href="https://links.hanzo.ai/4kkoula">
    Try on Comfy Cloud or download workflow
  </Card>
  <Card title="Recraft Creative" icon="cloud" href="https://links.hanzo.ai/4afKfOJ">
    Try on Comfy Cloud or download workflow
