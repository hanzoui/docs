---
title: "Hanzo Studio preprocessor workflows"
description: "Learn how to use depth estimation, lineart conversion, pose detection, and normals extraction preprocessors in Hanzo Studio"
...
<Note>
These workflows contain custom nodes. You need to install them using [Hanzo Manager](/manager/overview) before running the workflows.
</Note>
...
<Card title="Depth Estimation Workflow" icon="cloud" href="https://cloud.hanzo.ai/?template=utility-depthAnything-v2-relative-video&utm_source=docs&utm_medium=inhouse_social&utm_campaign=inhouse_feature_launches&utm_content=post&utm_niche=workflow_engineering&utm_creator=purz">
  Run on Comfy Cloud
</Card>

<Card title="Download Workflow" icon="download" href="https://github.com/hanzoui/workflow-templates/blob/main/templates/utility-depthAnything-v2-relative-video.json">
  Download JSON
</Card>
...
<Card title="Lineart Conversion Workflow" icon="cloud" href="https://cloud.hanzo.ai/?template=utility-lineart-video&utm_source=docs&utm_medium=inhouse_social&utm_campaign=inhouse_feature_launches&utm_content=post&utm_niche=workflow_engineering&utm_creator=purz">
  Run on Comfy Cloud
</Card>

<Card title="Download Workflow" icon="download" href="https://github.com/hanzoui/workflow-templates/blob/main/templates/utility-lineart-video.json">
  Download JSON
</Card>
...
<Card title="Pose Detection Workflow" icon="cloud" href="https://cloud.hanzo.ai/?template=utility-openpose-video&utm_source=docs&utm_medium=inhouse_social&utm_campaign=inhouse_feature_launches&utm_content=post&utm_niche=workflow_engineering&utm_creator=purz">
  Run on Comfy Cloud
</Card>

<Card title="Download Workflow" icon="download" href="https://github.com/hanzoui/workflow-templates/blob/main/templates/utility-openpose-video.json">
  Download JSON
</Card>
...
<Card title="Normals Extraction Workflow" icon="cloud" href="https://cloud.hanzo.ai/?template=utility-normal_crafter-video&utm_source=docs&utm_medium=inhouse_social&utm_campaign=inhouse_feature_launches&utm_content=post&utm_niche=workflow_engineering&utm_creator=purz">
  Run on Comfy Cloud
</Card>

<Card title="Download Workflow" icon="download" href="https://github.com/hanzoui/workflow-templates/blob/main/templates/utility-normal_crafter-video.json">
  Download JSON
</Card>
