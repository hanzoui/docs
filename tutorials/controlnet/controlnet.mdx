---
title: "Hanzo Studio ControlNet Usage Example"
description: "This guide will introduce you to the basic concepts of ControlNet and demonstrate how to generate corresponding images in Hanzo Studio"
...
![Images generated with random seeds in Hanzo Studio](/images/tutorial/controlnet/generated_with_random_seed.jpg)
...
![Sketch-controlled image generation in Hanzo Studio](/images/tutorial/controlnet/scribble_example.jpg)

In this example, we will guide you through installing and using ControlNet models in [Hanzo Studio](https://github.com/hanzoai/studio), and complete a sketch-controlled image generation example.

![Hanzo Studio ControlNet Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/scribble_controlnet.png)
...
![Reference Images](https://github.com/Fannovel16/hanzo_studio_controlnet_aux/blob/main/examples/CNAuxBanner.jpg?raw=true)

> Image source: [Hanzo Studio ControlNet aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux)
...
## Hanzo Studio ControlNet Workflow Example Explanation

### 1. ControlNet Workflow Assets

Please download the workflow image below and drag it into Hanzo Studio to load the workflow:

![Hanzo Studio Workflow - ControlNet](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/scribble_controlnet.png)

<Tip>
Images with workflow JSON in their metadata can be directly dragged into Hanzo Studio or loaded using the menu `Workflows` -> `Open (ctrl+o)`.
This image already includes download links for the corresponding models, and dragging it into Hanzo Studio will automatically prompt for downloads.
</Tip>

Please download the image below, which we will use as input:

![Hanzo Studio Sketch Image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/scribble_input.png)
...
- [control_v11p_sd15_scribble_fp16.safetensors](https://huggingface.co/hanzoai/ControlNet-v1-1_fp16_safetensors/resolve/main/control_v11p_sd15_scribble_fp16.safetensors?download=true)
...
![Hanzo Studio Workflow - ControlNet Flow Diagram](/images/tutorial/controlnet/flow_diagram_scribble.png)
...
Models located in `Hanzo Studio\models\controlnet` will be detected by Hanzo Studio and can be loaded through this node.
...
3. Visit the [ControlNet-v1-1_fp16_safetensors](https://huggingface.co/hanzoai/ControlNet-v1-1_fp16_safetensors/tree/main) repository to download other types of ControlNet models and try using them to generate images.
