---
title: "Hanzo Studio Depth T2I Adapter Usage Example"
description: "This guide will introduce you to the basic concepts of Depth T2I Adapter and demonstrate how to generate corresponding images in Hanzo Studio"
...
In Hanzo Studio, using T2I Adapter is similar to [ControlNet](/tutorials/controlnet/controlnet) in terms of interface and workflow. In this example, we will demonstrate how to use a depth T2I Adapter to control an interior scene.

![Hanzo Studio Depth T2I Adapter Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/depth-t2i-adapter.png)
...
## Hanzo Studio Depth T2I Adapter Workflow Example Explanation
...
![Hanzo Studio Workflow - Depth T2I Adapter](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/depth-t2i-adapter.png)
...
![Hanzo Studio Interior Depth Map](https://raw.githubusercontent.com/hanzoui/example-workflows/main/controlnet/depth-t2i-adapter_input.png)
...
![Hanzo Studio Workflow - Depth T2I Adapter Flow Diagram](/images/tutorial/controlnet/flow_diagram_depth_ti2_adapter.jpg)
