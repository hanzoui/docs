---
title: "Hanzo Studio Flux.2 Dev Example"
description: "This guide provides a brief introduction to the Flux.2 model and guides you through using the Flux.2 Dev model for text-to-image generation in Hanzo Studio."
