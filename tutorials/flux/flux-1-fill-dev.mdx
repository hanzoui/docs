---
title: "Hanzo Studio Flux.1 fill dev Example"
...
If you're not familiar with inpainting and outpainting workflows, you can refer to [Hanzo Studio Layout Inpainting Example](/tutorials/basic/inpaint) and [Hanzo Studio Image Extension Example](/tutorials/basic/outpaint) for some related explanations.
...
<a className="prose"  target='_blank'  href="https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/inpaint/flux_fill_inpaint.png" style={{ display: 'inline-block', backgroundColor: '#0078D6', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold', marginRight: '10px'}}>
    <p className="prose" style={{ margin: 0, fontSize: "0.8rem" }}>Download Workflow Image</p>
</a>

<a className="prose"  target='_blank'  href="https://cloud.hanzo.ai/?template=flux_fill_inpaint_example&utm_source=docs" style={{ display: 'inline-block', backgroundColor: '#28a745', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
...
![Hanzo Studio Flux.1 inpaint](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/inpaint/flux_fill_inpaint.png)

Please download the image below, we will use it as the input image
![Hanzo Studio Flux.1 inpaint input](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/inpaint/flux_fill_inpaint_input.png)

<Note>
The corresponding image already contains an alpha channel, so you don't need to draw a mask separately.
If you want to draw your own mask, please [click here](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/inpaint/flux_fill_inpaint_input_original.png) to get the image without a mask, and refer to the MaskEditor usage section in the [Hanzo Studio Layout Inpainting Example](/tutorials/basic/inpaint#using-the-mask-editor) to learn how to draw a mask in the `Load Image` node.
</Note>

### 2. Steps to run the workflow

![Hanzo Studio Flux.1 Fill dev Inpainting Workflow](/images/tutorial/flux/flow_diagram_inpaint.jpg)
...
Please download the image below and drag it into Hanzo Studio to load the corresponding workflow
![Hanzo Studio Flux.1 outpaint](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/outpaint/flux_fill_dev_outpaint.png)

Please download the image below, we will use it as the input image
![Hanzo Studio Flux.1 outpaint input](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/outpaint/flux_fill_dev_outpaint_input.png)

### 2. Steps to run the workflow

![Hanzo Studio Flux.1 Fill dev Outpainting Workflow](/images/tutorial/flux/flow_diagram_outpaint.jpg)
