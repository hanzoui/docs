...
Use [HanzoStudio-Advanced-ControlNet](https://github.com/Kosinkadink/HanzoStudio-Advanced-ControlNet) or [Hanzo Studio ControlNet aux](https://github.com/Fannovel16/hanzo_studio_controlnet_aux) to complete image preprocessing
...
Place these files in the `HanzoStudio/models/controlnet` directory.
