---
title: "Hanzo Studio Flux.2 Klein 4B Guide"
description: "A quick introduction to FLUX.2 [klein] 4B and how to run text-to-image and image editing workflows in Hanzo Studio."
...
<CardGroup cols={3}>
  <Card title="4B Text-to-Image Workflow" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/image_flux2_klein_text_to_image.json">
    Download the text-to-image workflow for Flux.2 Klein 4B.
  </Card>
  <Card title="4B Image Edit Base" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/image_flux2_klein_image_edit_4b_base.json">
    Download the image editing workflow using the 4B base model.
  </Card>
  <Card title="4B Image Edit Distilled" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/image_flux2_klein_image_edit_4b_distilled.json">
...
<CardGroup cols={2}>
  <Card title="qwen_3_4b.safetensors" icon="download" href="https://huggingface.co/hanzoui/flux2-klein-4B/resolve/main/split_files/text_encoders/qwen_3_4b.safetensors">
  ...
  <Card title="flux2-vae.safetensors" icon="download" href="https://huggingface.co/hanzoui/flux2-dev/resolve/main/split_files/vae/flux2-vae.safetensors">
    VAE for 4B models.
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="9B Text-to-Image Workflow" icon="download" href="http://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/image_flux2_text_to_image_9b.json">
    Download the text-to-image workflow for Flux.2 Klein 9B.
  </Card>
  <Card title="9B Image Edit Base" icon="download" href="http://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/image_flux2_klein_image_edit_9b_base.json">
    Download the image editing workflow using the 9B base model.
  </Card>
  <Card title="9B Image Edit Distilled" icon="download" href="http://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/image_flux2_klein_image_edit_9b_distilled.json">
...
<CardGroup cols={2}>
  ...
  <Card title="qwen_3_8b_fp8mixed.safetensors" icon="download" href="https://huggingface.co/hanzoui/flux2-klein-9B/resolve/main/split_files/text_encoders/qwen_3_8b_fp8mixed.safetensors">
