---
title: "Flux.1 Krea Dev Hanzo Studio Workflow Tutorial"
...
## Flux.1 Krea Dev Hanzo Studio Workflow

<UpdateReminder />

#### 1. Workflow Files

Download the image or JSON below and drag it into Hanzo Studio to load the corresponding workflow
![Flux Krea Dev Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/krea/flux1_krea_dev.png)

<a className="prose"  target='_blank'  href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/flux1_krea_dev.json" style={{ display: 'inline-block', backgroundColor: '#0078D6', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold', marginRight: '10px'}}>
    <p className="prose" style={{ margin: 0, fontSize: "0.8rem" }}>Download JSON Workflow</p>
</a>

<a className="prose"  target='_blank'  href="https://cloud.hanzo.ai/?template=flux1_krea_dev&utm_source=docs" style={{ display: 'inline-block', backgroundColor: '#28a745', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
...
- [flux1-krea-dev_fp8_scaled.safetensors](https://huggingface.co/hanzoui/FLUX.1-Krea-dev_Hanzo Studio/blob/main/split_files/diffusion_models/flux1-krea-dev_fp8_scaled.safetensors)
...
- [t5xxl_fp8_e4m3fn.safetensors](https://huggingface.co/hanzoai/flux_text_encoders/resolve/main/t5xxl_fp8_e4m3fn.safetensors)  For Low VRAM
...
![Hanzo Studio Flux Krea Dev Workflow](/images/tutorial/flux/flux_1_krea_dev_guide.jpg)
