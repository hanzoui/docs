...
- [flux1-krea-dev_fp8_scaled.safetensors](https://huggingface.co/hanzoui/FLUX.1-Krea-dev_HanzoStudio/blob/main/split_files/diffusion_models/flux1-krea-dev_fp8_scaled.safetensors)
