---
title: "ByteDance USO Hanzo Studio Native Workflow example"
...
## ByteDance USO Hanzo Studio Native Workflow
...
![Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/flux/bytedance-uso/bytedance-uso.png)

<a 
className="prose"
target='_blank'
href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/flux1_dev_uso_reference_image_gen.json"
...
<a className="prose"  target='_blank'  href="https://cloud.hanzo.ai/?template=flux1_dev_uso_reference_image_gen&utm_source=docs" style={{ display: 'inline-block', backgroundColor: '#28a745', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
    <p className="prose" style={{ margin: 0, fontSize: "0.8rem" }}>Run on Comfy Cloud</p>
</a>

Use the image below as an input image.

![input](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/flux/bytedance-uso/input.png)
...
- [flux1-dev-fp8.safetensors](https://huggingface.co/hanzoui/flux1-dev/resolve/main/flux1-dev-fp8.safetensors)

**loras**

- [uso-flux1-dit-lora-v1.safetensors](https://huggingface.co/hanzoui/USO_1.0_Repackaged/resolve/main/split_files/loras/uso-flux1-dit-lora-v1.safetensors)

**model_patches**

- [uso-flux1-projector-v1.safetensors](https://huggingface.co/hanzoui/USO_1.0_Repackaged/resolve/main/split_files/model_patches/uso-flux1-projector-v1.safetensors)

**clip_visions**
- [sigclip_vision_patch14_384.safetensors](https://huggingface.co/hanzoui/sigclip_vision_384/resolve/main/sigclip_vision_patch14_384.safetensors)
