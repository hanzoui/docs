...
- [flux1-dev-kontext_fp8_scaled.safetensors](https://huggingface.co/hanzoui/flux1-kontext-dev_HanzoStudio/resolve/main/split_files/diffusion_models/flux1-dev-kontext_fp8_scaled.safetensors)
