---
title: "Hanzo Studio Flux Kontext Dev Native Workflow Example"
description: "Hanzo Studio Flux Kontext Dev Native Workflow Example."
...
Currently in Hanzo Studio, you can use all these versions, where [Pro and Max versions](/tutorials/partner-nodes/black-forest-labs/flux-1-kontext) can be called through API nodes, while the Dev open source version please refer to the instructions in this guide.
...
- [flux1-dev-kontext_fp8_scaled.safetensors](https://huggingface.co/hanzoui/flux1-kontext-dev_Hanzo Studio/resolve/main/split_files/diffusion_models/flux1-dev-kontext_fp8_scaled.safetensors)
...
**VAE**
- [ae.safetensors](https://huggingface.co/hanzoui/Lumina_Image_2.0_Repackaged/blob/main/split_files/vae/ae.safetensors)

**Text Encoder**
- [clip_l.safetensors](https://huggingface.co/hanzoai/flux_text_encoders/blob/main/clip_l.safetensors)
- [t5xxl_fp16.safetensors](https://huggingface.co/hanzoai/flux_text_encoders/resolve/main/t5xxl_fp16.safetensors) or [t5xxl_fp8_e4m3fn_scaled.safetensors](https://huggingface.co/hanzoai/flux_text_encoders/resolve/main/t5xxl_fp8_e4m3fn_scaled.safetensors)
...
<a className="prose"  target='_blank'  href="https://cloud.hanzo.ai/?template=flux_kontext_dev_basic&utm_source=docs" style={{ display: 'inline-block', backgroundColor: '#28a745', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
...
Download the following files and drag them into Hanzo Studio to load the corresponding workflow

![Hanzo Studio Flux.1 Kontext Pro Image API Node Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/kontext/dev/flux_1_kontext_dev_basic.png)

**Input Image**

![Hanzo Studio Flux Kontext Native Workflow Input](https://raw.githubusercontent.com/hanzoui/example-workflows/main/flux/kontext/dev/rabbit.jpg)
