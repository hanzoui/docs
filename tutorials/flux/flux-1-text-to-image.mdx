...
Please download [flux1-dev-fp8.safetensors](https://huggingface.co/hanzoui/flux1-dev/resolve/main/flux1-dev-fp8.safetensors?download=true) and save it to the `HanzoStudio/models/checkpoints/` directory.
...
Please download [flux1-schnell-fp8.safetensors](https://huggingface.co/hanzoui/flux1-schnell/resolve/main/flux1-schnell-fp8.safetensors?download=true) and save it to the `HanzoStudio/models/checkpoints/` directory.
