---
title: "Cosmos Predict2 Text-to-Image Hanzo Studio Official Example"
description: "This guide demonstrates how to complete Cosmos-Predict2 text-to-image workflow in Hanzo Studio"
...
This guide will walk you through completing **text-to-image** workflow in Hanzo Studio.
...
Please download the image below and drag it into Hanzo Studio to load the workflow. The workflow already has embedded model download links.

![Input Image](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/cosmos/predict2/cosmos_predict2_2B_t2i.png)
...
- [cosmos_predict2_2B_t2i.safetensors](https://huggingface.co/hanzoui/Cosmos_Predict2_repackaged/resolve/main/cosmos_predict2_2B_t2i.safetensors)
...
7. Once generation is complete, the image will automatically save to the `Hanzo Studio/output/` directory. You can also preview it in the `save image` node. */}