---
title: "Z-Image-Turbo Hanzo Studio Workflow Example"
...
<CardGroup cols={2}>
  <Card title="Download Workflow" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/image_z_image_turbo.json">
    Download the Z-Image-Turbo text-to-image workflow JSON file.
  </Card>
  <Card title="Run on Hanzo Studio Cloud" icon="cloud" href="https://cloud.hanzo.ai/?template=image_z_image_turbo&utm_source=docs&utm_medium=inhouse_social&utm_campaign=z_image_launch">
    Run this workflow directly on Hanzo Studio Cloud.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="qwen_3_4b.safetensors" icon="download" href="https://huggingface.co/hanzoui/z_image_turbo/resolve/main/split_files/text_encoders/qwen_3_4b.safetensors">
    Text encoder for Z-Image-Turbo.
  </Card>
  <Card title="z_image_turbo_bf16.safetensors" icon="download" href="https://huggingface.co/hanzoui/z_image_turbo/resolve/main/split_files/diffusion_models/z_image_turbo_bf16.safetensors">
    Diffusion model for Z-Image-Turbo.
  </Card>
  <Card title="ae.safetensors" icon="download" href="https://huggingface.co/hanzoui/z_image_turbo/resolve/main/split_files/vae/ae.safetensors">
...
<CardGroup cols={1}>
  <Card title="Download Workflow" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/image_z_image_turbo_fun_union_controlnet.json">
