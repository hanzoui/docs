---
title: "Z-Image Hanzo Studio Workflow Example"
...
<CardGroup cols={2}>
  <Card title="Download Workflow" icon="download" href="https://raw.githubusercontent.com/hanzoui/workflow-templates/refs/heads/main/templates/image_z_image.json">
    Download the Z-Image text-to-image workflow JSON file.
  </Card>
  <Card title="Run on Hanzo Studio Cloud" icon="cloud" href="https://cloud.hanzo.ai/?template=image_z_image&utm_source=docs&utm_medium=inhouse_social&utm_campaign=z_image_launch">
...
<CardGroup cols={2}>
  ...
  <Card title="z_image_bf16.safetensors" icon="download" href="https://huggingface.co/hanzoui/z_image/resolve/main/split_files/diffusion_models/z_image_bf16.safetensors">
