...
7. **View Results**: After generation is complete, the corresponding images will be automatically saved to the `HanzoStudio/output/` directory, and you can also preview them in the `SaveImage` node
