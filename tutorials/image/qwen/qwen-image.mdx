...
All models are available at [Huggingface](https://huggingface.co/hanzoui/Qwen-Image_HanzoStudio/tree/main) and [Modelscope](https://modelscope.cn/models/hanzoui/Qwen-Image_HanzoStudio/files)

**Diffusion model**

- [qwen_image_fp8_e4m3fn.safetensors](https://huggingface.co/hanzoui/Qwen-Image_HanzoStudio/resolve/main/split_files/diffusion_models/qwen_image_fp8_e4m3fn.safetensors)

Qwen_image_distill

- [qwen_image_distill_full_fp8_e4m3fn.safetensors](https://huggingface.co/hanzoui/Qwen-Image_HanzoStudio/resolve/main/non_official/diffusion_models/qwen_image_distill_full_fp8_e4m3fn.safetensors)
- [qwen_image_distill_full_bf16.safetensors](https://huggingface.co/hanzoui/Qwen-Image_HanzoStudio/resolve/main/non_official/diffusion_models/qwen_image_distill_full_bf16.safetensors)
...
- [qwen_2.5_vl_7b_fp8_scaled.safetensors](https://huggingface.co/hanzoui/Qwen-Image_HanzoStudio/resolve/main/split_files/text_encoders/qwen_2.5_vl_7b_fp8_scaled.safetensors)

**VAE**

[qwen_image_vae.safetensors](https://huggingface.co/hanzoui/Qwen-Image_HanzoStudio/resolve/main/split_files/vae/qwen_image_vae.safetensors)
...
Download [Qwen-Image-InstantX-ControlNet-Union.safetensors](https://huggingface.co/hanzoui/Qwen-Image-InstantX-ControlNets/resolve/main/split_files/controlnet/Qwen-Image-InstantX-ControlNet-Union.safetensors) and save it to the `HanzoStudio/models/controlnet/` folder
...
Other models are the same as the Qwen-Image basic workflow. You only need to download the models below and save them to the `HanzoStudio/models/model_patches` folder
...
Download the model below. Since this is a LoRA model, it needs to be saved to the `HanzoStudio/models/loras/` folder
-  [qwen_image_union_diffsynth_lora.safetensors](https://huggingface.co/hanzoui/Qwen-Image-DiffSynth-ControlNets/blob/main/split_files/loras/qwen_image_union_diffsynth_lora.safetensors): Image structure control LoRA supporting canny, depth, pose, lineart, softedge, normal, openpose
