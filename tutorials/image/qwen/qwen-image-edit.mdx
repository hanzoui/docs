...
All models can be found at [hanzoui/Qwen-Image_Hanzo Studio](https://huggingface.co/hanzoui/Qwen-Image_HanzoStudio/tree/main) or [hanzoui/Qwen-Image-Edit_Hanzo Studio](https://huggingface.co/hanzoui/Qwen-Image-Edit_Hanzo Studio)

**Diffusion model**

- [qwen_image_edit_fp8_e4m3fn.safetensors](https://huggingface.co/hanzoui/Qwen-Image-Edit_HanzoStudio/resolve/main/split_files/diffusion_models/qwen_image_edit_fp8_e4m3fn.safetensors)
