---
title: "Hanzo Studio Native HiDream-E1, E1.1 Workflow Example"
sidebarTitle: "HiDream-e1"
description: "This guide will help you understand and complete the Hanzo Studio native HiDream-I1 text-to-image workflow example"
---
...
All the models involved in this guide can be found [here](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/tree/main/split_files). Except for the Diffusion model, E1 and E1.1 use the same models.
...
- [hidream_e1_1_bf16.safetensors (Recommended)](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/resolve/main/split_files/diffusion_models/hidream_e1_1_bf16.safetensors) 34.2GB
- [hidream_e1_full_bf16.safetensors](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/resolve/main/split_files/diffusion_models/hidream_e1_full_bf16.safetensors) 34.2GB

**Text Encoder**:

- [clip_l_hidream.safetensors](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/blob/main/split_files/text_encoders/clip_l_hidream.safetensors) 236.12MB
- [clip_g_hidream.safetensors](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/blob/main/split_files/text_encoders/clip_g_hidream.safetensors) 1.29GB
- [t5xxl_fp8_e4m3fn_scaled.safetensors](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/blob/main/split_files/text_encoders/t5xxl_fp8_e4m3fn_scaled.safetensors) 4.8GB
- [llama_3.1_8b_instruct_fp8_scaled.safetensors](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/blob/main/split_files/text_encoders/llama_3.1_8b_instruct_fp8_scaled.safetensors) 8.46GB

**VAE**
- [ae.safetensors](https://huggingface.co/hanzoui/HiDream-I1_Hanzo Studio/blob/main/split_files/vae/ae.safetensors) 319.77MB
...
## HiDream E1.1 Hanzo Studio Native Workflow Example
...
Download the image below and drag it into Hanzo Studio with the corresponding workflow and models loaded:
![HiDream E1.1 Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/hidream/e1.1/hidream_e1_1.png)

Download the image below as input:
![HiDream E1.1 Workflow Input](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/hidream/e1.1/input.webp)
...
## HiDream E1 Hanzo Studio Native Workflow Example

<a className="prose" target='_blank' href="https://cloud.hanzo.ai/?template=hidream_e1_full&utm_source=docs" style={{ display: 'inline-block', backgroundColor: '#28a745', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
...
Please download the image below and drag it into Hanzo Studio. The workflow already contains model download information, and after loading, it will prompt you to download the corresponding models.

![Hanzo Studio Native HiDream-e1 Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/hidream_e1/hidream_e1_full.png)

Download this image below as input:
![Hanzo Studio Native HiDream-e1 Workflow Input](https://raw.githubusercontent.com/hanzoui/example-workflows/main/hidream_e1/input.webp)
...
### Additional Notes on Hanzo Studio HiDream-e1 Workflow
