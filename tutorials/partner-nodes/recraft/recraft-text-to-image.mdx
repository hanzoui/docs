---
title: "Recraft Text to Image API Node Hanzo Studio Official Example"
description: "Learn how to use the Recraft Text to Image Partner node in Hanzo Studio"
...
![Recraft Text to Image Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/recraft/t2i/recraft_t2i.png)
...
5. After the API returns the result, you can view the generated image in the `Save Image` node. The image will also be saved to the `Hanzo Studio/output/` directory
