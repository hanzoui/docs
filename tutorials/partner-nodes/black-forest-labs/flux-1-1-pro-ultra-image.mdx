---
title: "Flux 1.1 Pro Ultra Image API Node Hanzo Studio Official Workflow Examples"
description: "This guide covers how to use the Flux 1.1 Pro Ultra Image Partner node in Hanzo Studio"
...
We now support the Flux 1.1 Pro Ultra Image node in Hanzo Studio. This guide will cover:
...
Download and drag the following file into Hanzo Studio to load the workflow:

![Flux 1.1 pro Text-to-Image Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/bfl/flux_1_1_pro_t2i.png)
...
4. After the API returns results, view the generated image in the `Save Image` node. Images are saved to the `Hanzo Studio/output/` directory
...
Download and drag the following file into Hanzo Studio, or right-click the purple node in the Text-to-Image workflow and set `mode` to `always` to enable `image_prompt` input:

![Flux 1.1 pro Image-to-Image Remix](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/bfl/flux_1_1_pro_i2i.png)

We'll use this image as input:
![Input Image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/openai-dall-e-3/text2image.png)
