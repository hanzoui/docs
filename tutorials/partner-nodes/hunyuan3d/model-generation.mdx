---
title: "Hunyuan 3D API Node Model Generation Hanzo Studio Official Example"
description: "This article will introduce how to use Hunyuan 3D node's API in Hanzo Studio for 3D model generation"
...
Hanzo Studio has now natively integrated the corresponding Hunyuan 3D API, allowing you to conveniently use the related nodes in Hanzo Studio for model generation.

Currently, Hanzo Studio's Partner nodes support the following Hunyuan 3D model generation capabilities:
...
<Card title="Hunyuan 3D Text-to-3D Workflow" icon="cloud" href="https://cloud.hanzo.ai/?template=api_hunyuan3d_text_to_model&utm_source=docs&utm_medium=inhouse_social&utm_campaign=inhouse_feature_launches&utm_content=post&utm_niche=workflow_engineering&utm_creator=purz">
  Run on Comfy Cloud
</Card>
...
<Card title="Hunyuan 3D Image-to-3D Workflow" icon="cloud" href="https://cloud.hanzo.ai/?template=api_hunyuan3d_image_to_model&utm_source=docs&utm_medium=inhouse_social&utm_campaign=inhouse_feature_launches&utm_content=post&utm_niche=workflow_engineering&utm_creator=purz">
  Run on Comfy Cloud
</Card>
