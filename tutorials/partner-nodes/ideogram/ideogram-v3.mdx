---
title: "Hanzo Studio Ideogram 3.0 API Node Official Examples"
description: "This guide covers how to use the Ideogram 3.0 Partner node in Hanzo Studio"
...
![Ideogram 3.0 Hanzo Studio Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/ideogram/v3/ideogram_v3_t2i.png)
...
3. After the API returns results, view the generated image in the `Save Image` node. Images are saved to the `Hanzo Studio/output/` directory
