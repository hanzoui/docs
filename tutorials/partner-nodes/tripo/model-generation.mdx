---
title: "Tripo API Node Model Generation Hanzo Studio Official Example"
description: "This article will introduce how to use Tripo node's API in Hanzo Studio for model generation"
...
Hanzo Studio has now natively integrated the corresponding Tripo API, allowing you to conveniently use the related nodes in Hanzo Studio for model generation.

Currently, Hanzo Studio's Partner nodes support the following Tripo model generation capabilities:
- Text-to-model
- Image-to-model
...
<a className="prose"  target='_blank'  href="https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/api_nodes/tripo/api_tripo_text_to_model.json" style={{ display: 'inline-block', backgroundColor: '#0078D6', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
...
![Hanzo Studio Tripo Text to Model Step Guide](/images/tutorial/api_nodes/tripo/tripo_text_to_model_step_guide.jpg)
...
2. Click the `Run` button, or use the shortcut `Ctrl(cmd) + Enter` to execute model generation. After the workflow completes, the corresponding model will be automatically saved to the `Hanzo Studio/output/` directory
...
<a className="prose"  target='_blank'  href="https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/api_nodes/tripo/image_to_model/api_tripo_image_to_model.json" style={{ display: 'inline-block', backgroundColor: '#0078D6', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
    <p className="prose" style={{ margin: 0, fontSize: "0.8rem" }}>Download Json Format Workflow File</p>
</a>
...
![Input Image](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/api_nodes/tripo/image_to_model/panda.jpg)
### 2. Complete the Workflow Execution Step by Step

![Hanzo Studio Tripo Text to Model Step Guide](/images/tutorial/api_nodes/tripo/tripo_image_to_model_step_guide.jpg)
...
2. In the `Tripo: Image to Model` node, modify the corresponding parameter settings
   ...
   - style: You can set different styles
   - texture_quality: You can set different texture qualities
3. Click the `Run` button, or use the shortcut `Ctrl(cmd) + Enter` to execute model generation. After the workflow completes, the corresponding model will be automatically saved to the `Hanzo Studio/output/` directory
...
<a className="prose"  target='_blank'  href="https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/api_nodes/tripo/multiview_to_image/api_tripo_multiview_to_model.json" style={{ display: 'inline-block', backgroundColor: '#0078D6', color: '#ffffff', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
    <p className="prose" style={{ margin: 0, fontSize: "0.8rem" }}>Download Json Format Workflow File</p>
</a>
...
![Front View](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/api_nodes/tripo/multiview_to_image/front.jpg)
![Back View](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/api_nodes/tripo/multiview_to_image/back.jpg)

### 2. Complete the Workflow Execution Step by Step

![Hanzo Studio Tripo Text to Model Step Guide](/images/tutorial/api_nodes/tripo/tripo_multiview_to_model_step_guide.jpg)
