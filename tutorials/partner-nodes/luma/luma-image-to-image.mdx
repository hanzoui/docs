---
title: "Luma Image to Image API Node Hanzo Studio Official Example"
description: "This guide covers how to use the Luma Image to Image Partner node in Hanzo Studio"
...
Download and drag the following image into Hanzo Studio to load the workflow (workflow information is included in the image metadata):

![Luma Image to Image Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/i2i/luma_i2i.png)

Download this image to use as input:

![Luma Image to Image Workflow Input Image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/i2i/input.png)
...
5. After API returns results, view the generated image in the `Save Image` node. Images are saved to the `Hanzo Studio/output/` directory
