---
title: "Luma Text to Video API Node Hanzo Studio Official Guide"
description: "Learn how to use the Luma Text to Video Partner node in Hanzo Studio"
...
![Luma Text to Video Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/t2v/luma_t2v.mp4)
...
3. After the API returns results, you can view the generated video in the `Save Video` node. The video will also be saved to the `Hanzo Studio/output/` directory
