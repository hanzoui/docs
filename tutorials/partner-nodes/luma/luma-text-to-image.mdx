---
title: "Luma Text to Image API Node Hanzo Studio Official Example"
description: "This guide explains how to use the Luma Text to Image Partner node in Hanzo Studio"
...
The workflow information is included in the metadata of the image below. Download and drag it into Hanzo Studio to load the workflow.

![Luma Text to Image Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/t2i/luma_t2i.png)

Please download these images for input:

![Input Image - Reference](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/t2i/input_ref.png)
![Input Image - Style](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/t2i/input_style.png)
...
6. After the API returns results, view the generated image in the `Save Image` node. Images are saved to the `Hanzo Studio/output/` directory
