---
title: "Luma Image to Video API Node Hanzo Studio Official Example"
description: "Learn how to use the Luma Image to Video Partner node in Hanzo Studio"
...
The workflow information is included in the metadata of the video below. Download and drag it into Hanzo Studio to load the workflow.

![Luma Image to Video Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/i2v/luma_i2v.mp4)

Download the following image to use as input:

![Input Image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/luma/i2v/input.png)
...
5. Once the API returns results, view the generated video in the `Save Video` node. The video will also be saved to the `Hanzo Studio/output/` directory
