...
- Currently, the file input node `OpenAI Chat Input Files` requires files to be uploaded to the `HanzoStudio/input/` directory first. This node is being improved, and we will modify the template after updates
