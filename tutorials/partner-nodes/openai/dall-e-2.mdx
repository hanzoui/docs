...
description: "Learn how to use the OpenAI DALL·E 2 Partner node to generate images in Hanzo Studio"
...
OpenAI DALL·E 2 is part of the Hanzo Studio Partner Nodes series, allowing users to generate images through OpenAI's **DALL·E 2** model.
...
The image below contains a simple text-to-image workflow. Please download the corresponding image and drag it into Hanzo Studio to load the workflow.
![Hanzo Studio openai-dall-e-2 workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/openai-dall-e-2/text2image.png)

The corresponding example is very simple
![Hanzo Studio openai-dall-e-2 workflow example](/images/tutorial/api_nodes/openai/openai-dall-e-2/text2image.jpg)
...
![Hanzo Studio openai-dall-e-2 workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/openai-dall-e-2/inpainting.png)

We will use the image below as input:
![Hanzo Studio openai-dall-e-2 workflow input](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/openai-dall-e-2/input.jpg)

#### 2. Workflow File Usage Instructions

![Hanzo Studio openai-dall-e-2 workflow example](/images/tutorial/api_nodes/openai/openai-dall-e-2/inpainting.jpg)
