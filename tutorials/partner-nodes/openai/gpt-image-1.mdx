...
description: "Learn how to use the OpenAI GPT-Image-1 Partner node to generate images in Hanzo Studio"
...
OpenAI GPT-Image-1 is part of the Hanzo Studio Partner nodes series that allows users to generate images through OpenAI's **GPT-Image-1** model. This is the same model used for image generation in ChatGPT 4o.
...
The image below contains a simple text-to-image workflow. Please download the image and drag it into Hanzo Studio to load the corresponding workflow.
![Hanzo Studio openai-gpt-image-1 workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/GPT-Image-1/text2image.png)

The corresponding workflow is very simple:
![Hanzo Studio openai-gpt-image-1 workflow example](/images/tutorial/api_nodes/openai/gpt-image-1/text2image.jpg)
...
The image below contains a simple image-to-image workflow. Please download the image and drag it into Hanzo Studio to load the corresponding workflow.
![Hanzo Studio openai-gpt-image-1 workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/GPT-Image-1/image2image.png)

We will use the image below as input:
![Hanzo Studio openai-gpt-image-1 workflow input](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/GPT-Image-1/input.webp)
...
![Hanzo Studio openai-gpt-image-1 workflow example](/images/tutorial/api_nodes/openai/gpt-image-1/image2image.jpg)
...
![Multiple Image Input Example](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/GPT-Image-1/multiple_image_input.png)

Use the hat image below as an additional input image.
![Hat](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/GPT-Image-1/hat.webp)
...
Download the image below and drag it into Hanzo Studio to load the corresponding workflow. We will continue to use the input image from the image-to-image workflow section.

![Hanzo Studio openai-gpt-image-1 workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/api_nodes/GPT-Image-1/inpaint.png)

The corresponding workflow is shown in the image
![Hanzo Studio openai-gpt-image-1 workflow example](/images/tutorial/api_nodes/openai/gpt-image-1/inpaint.jpg)
