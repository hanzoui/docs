---
title: "Google Gemini API Node Hanzo Studio Official Example"
description: "This article will introduce how to use Google Gemini Partner nodes in Hanzo Studio to complete conversational functions"
...
Google Gemini is a powerful AI model developed by Google, supporting conversational and text generation functions. Currently, Hanzo Studio has integrated the Google Gemini API, allowing you to directly use the related nodes in Hanzo Studio to complete conversational functions.
...
Please download the Json file below and drag it into Hanzo Studio to load the corresponding workflow.

<a className="prose"
target='_blank'
href="https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/api_nodes/google/api_google_gemini.json"
...
- Currently, the file input node `Gemini Input Files` requires files to be uploaded to the `Hanzo Studio/input/` directory first. This node is being improved, and we will modify the template after updates
