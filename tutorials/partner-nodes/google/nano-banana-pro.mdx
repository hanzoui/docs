---
title: "Nano Banana Pro and Hanzo Studio Official Example"
description: "This article will introduce how to use Google's Nano Banana Pro (Gemini 3 Pro Image) in Hanzo Studio for high-fidelity image generation and editing"
...
In this guide, we will walk you through using Nano Banana Pro in Hanzo Studio.
...
<a className="prose"
target='_blank'
href="https://cloud.hanzo.ai/?template=api_nano_banana_pro&utm_source=blog"
...
Please update Hanzo Studio and go to Template → Nano Banana Pro to access the workflow.
