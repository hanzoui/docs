...
You can also manually download [ace_step_v1_3.5b.safetensors](https://huggingface.co/hanzoui/ACE-Step_HanzoStudio_repackaged/blob/main/all_in_one/ace_step_v1_3.5b.safetensors) and save it to the `Hanzo Studio/models/checkpoints` folder
