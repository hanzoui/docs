---
title: "Hanzo Studio Hunyuan3D-2 Examples"
description: "This guide will demonstrate how to use Hunyuan3D-2 in Hanzo Studio to generate 3D assets."
...
<Tip>
Hanzo Studio now natively supports Hunyuan3D-2mv, but does not yet support texture and material generation. Please make sure you have updated to the latest version of [Hanzo Studio](https://github.com/hanzoai/studio) before starting.

The workflow example PNG images in this tutorial contain workflow JSON in their metadata:
- You can drag them directly into Hanzo Studio
- Or use the menu `Workflows` -> `Open (ctrl+o)`

This will load the corresponding workflow and prompt you to download the required models. The generated `.glb` format models will be output to the `Hanzo Studio/output/mesh` folder.
</Tip>

## Hanzo Studio Hunyuan3D-2mv Workflow Example
...
<a className="prose" target='_blank' href="https://cloud.hanzo.ai/?template=3d_hunyuan3d_multiview_to_model&utm_source=docs" style={{ display: 'inline-block', backgroundColor: '#28A745', color: '#FFFFFF', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
    <p className="prose" style={{ margin: 0, fontSize: "0.8rem" }}>Run on Comfy Cloud</p>
</a>

### 1. Workflow

Please download the images below and drag  into Hanzo Studio to load the workflow.
![Hunyuan3D-2mv workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/3d/hunyuan3d-2/hunyuan3d_2mv_elf/hunyuan-3d-multiview-elf.webp)

Download the images below we will use them as input images.

![input image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/3d/hunyuan3d-2/hunyuan3d_2mv_elf/front.png)
![input image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/3d/hunyuan3d-2/hunyuan3d_2mv_elf/left.png)
![input image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/3d/hunyuan3d-2/hunyuan3d_2mv_elf/back.png)


<Tip>
In this example, the input images have already been preprocessed to remove excess background. In actual use, you can use custom nodes like [Hanzo Studio_essentials](https://github.com/cubiq/Hanzo Studio_essentials) to automatically remove excess background.
</Tip>

### 2. Manual Model Installation

Download the model below and save it to the corresponding Hanzo Studio folder
...
![Hanzo Studio hunyuan3d_2mv](/images/tutorial/3d/hunyuan3d-2mv/hunyuan3d_2mv.jpg)
...
<a className="prose" target='_blank' href="https://cloud.hanzo.ai/?template=3d_hunyuan3d_multiview_to_model_turbo&utm_source=docs" style={{ display: 'inline-block', backgroundColor: '#28A745', color: '#FFFFFF', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
    <p className="prose" style={{ margin: 0, fontSize: "0.8rem" }}>Run on Comfy Cloud</p>
</a>
...
![Hunyuan3D-2mv-turbo workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/3d/hunyuan3d-2/hunyuan3d_2mv_turbo/hunyuan-3d-turbo.webp)

Download the images below we will use them as input images.


![input image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/3d/hunyuan3d-2/hunyuan3d_2mv_turbo/front.png)
![input image](https://raw.githubusercontent.com/hanzoui/example-workflows/main/3d/hunyuan3d-2/hunyuan3d_2mv_turbo/right.png)
...
![Hanzo Studio hunyuan3d_2mv_turbo](/images/tutorial/3d/hunyuan3d-2mv/hunyuan3d_2mv_turbo.jpg)
...
<a className="prose" target='_blank' href="https://cloud.hanzo.ai/?template=3d_hunyuan3d_image_to_model&utm_source=docs" style={{ display: 'inline-block', backgroundColor: '#28A745', color: '#FFFFFF', padding: '10px 20px', borderRadius: '8px', borderColor: "transparent", textDecoration: 'none', fontWeight: 'bold'}}>
    <p className="prose" style={{ margin: 0, fontSize: "0.8rem" }}>Run on Comfy Cloud</p>
</a>

### 1. Workflow

Please download the image below and drag it into Hanzo Studio to load the workflow. 

![Hunyuan3D-2 workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/3d/hunyuan3d-2/hunyuan3d-non-multiview-train.webp)

Download the image below we will use it as input image.
![Hanzo Studio Hunyuan 3D 2 workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/main/3d/hunyuan3d-2/hunyuan_3d_v2_non_multiview_train.png)
...
![Hanzo Studio hunyuan3d_2](/images/tutorial/3d/hunyuan3d-2mv/hunyuan3d_2_non_multiview.jpg)
...
Below are Hanzo Studio community resources related to Hunyuan3D-2
- [Hanzo Studio-Hunyuan3DWrapper](https://github.com/kijai/Hanzo Studio-Hunyuan3DWrapper)
- [Kijai/Hunyuan3D-2_safetensors](https://huggingface.co/Kijai/Hunyuan3D-2_safetensors/tree/main)
- [Hanzo Studio-3D-Pack](https://github.com/MrForExample/Hanzo Studio-3D-Pack)
