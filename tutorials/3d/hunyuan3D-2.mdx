...
<Tip>
In this example, the input images have already been preprocessed to remove excess background. In actual use, you can use custom nodes like [HanzoStudio_essentials](https://github.com/cubiq/HanzoStudio_essentials) to automatically remove excess background.
</Tip>
