---
title: "Hanzo Studio LoRA Example"
sidebarTitle: "LoRA"
...
In this example, we will learn how to load and use a LoRA model in [Hanzo Studio](https://github.com/hanzoai/studio), covering the following topics:
...
Download the [dreamshaper_8.safetensors](https://civitai.com/api/download/models/128713?type=Model&format=SafeTensor&size=pruned&fp=fp16) file and put it in your `Hanzo Studio/models/checkpoints` folder.

Download the [blindbox_V1Mix.safetensors](https://civitai.com/api/download/models/32988?type=Model&format=SafeTensor&size=full&fp=fp16) file and put it in your `Hanzo Studio/models/loras` folder.

## LoRA Workflow File

Download the image below and **drag it into Hanzo Studio** to load the workflow.
![Hanzo Studio Workflow - LoRA](/images/tutorial/basic/lora/lora.png)
...
![Hanzo Studio Workflow - LoRA Flow Diagram](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/lora.png)
...
Models in the `Hanzo Studio\models\loras` folder will be detected by Hanzo Studio and can be loaded using this node.
...
This node supports chain connections, allowing multiple `Load LoRA` nodes to be linked in series to apply multiple LoRA models. For more details, please refer to [Hanzo Studio Multiple LoRAs Example](/tutorials/basic/multiple-loras)
