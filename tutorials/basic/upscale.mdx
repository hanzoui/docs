---
title: "Hanzo Studio Image Upscale Workflow"
description: "This guide explains the concept of image upscaling in AI drawing and demonstrates how to implement an image upscaling workflow in Hanzo Studio"
...
This article covers one of many upscaling methods in Hanzo Studio. In this tutorial, we'll guide you through:
...
Save the model file (.pth) in `Hanzo Studio/models/upscale_models` directory
</Step>
</Steps>
...
Download and drag the following image into Hanzo Studio to load the basic upscaling workflow:
![Upscale workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/basic/upscale_workflow.png)
...
Download and drag this image into Hanzo Studio to load the combined workflow:
