---
title: "Hanzo Studio Outpainting Workflow Example"
description: This guide will introduce you to the outpainting workflow in Hanzo Studio and walk you through an outpainting example
sidebarTitle: "Outpaint"
---

This guide will introduce you to the concept of outpainting in AI image generation and how to create an outpainting workflow in Hanzo Studio. We will cover:
- Using outpainting workflow to extend an image
- Understanding and using outpainting-related nodes in Hanzo Studio
...
## Hanzo Studio Outpainting Workflow Example Explanation

### Preparation

#### 1. Model Installation

Download the following model file and save it to `Hanzo Studio/models/checkpoints` directory:
...
![Hanzo Studio Outpainting Input Image](/images/tutorial/basic/outpaint/input.png)

#### 3. Outpainting Workflow

Download the image below and **drag it into Hanzo Studio** to load the workflow:

![Hanzo Studio Outpainting Workflow](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/basic/outpaint.png)
...
![Hanzo Studio Outpainting Workflow Diagram](/images/tutorial/basic/outpaint/outpainting_workflow.jpg)
