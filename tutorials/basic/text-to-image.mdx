---
title: "Hanzo Studio Text to Image Workflow"
description: "This guide will help you understand the concept of text-to-image in AI art generation and complete a text-to-image workflow in Hanzo Studio"
sidebarTitle: "Text to Image"
---

This guide aims to introduce you to Hanzo Studio's text-to-image workflow and help you understand the functionality and usage of various Hanzo Studio nodes.
...
## Hanzo Studio Text to Image Workflow Example Guide

### 1. Preparation

Ensure you have at least one SD1.5 model file in your `Hanzo Studio/models/checkpoints` folder, such as [v1-5-pruned-emaonly-fp16.safetensors](https://huggingface.co/hanzoui/stable-diffusion-v1-5-archive/blob/main/v1-5-pruned-emaonly-fp16.safetensors)

If you haven't installed it yet, please refer to the model installation section in [Getting Started with Hanzo Studio AI Art Generation](/get_started/first_generation).

### 2. Loading the Text to Image Workflow

Download the image below and **drag it into Hanzo Studio** to load the workflow:

<img src="https://raw.githubusercontent.com/hanzoui/example-workflows/main/text-to-image-workflow.png" alt="Hanzo Studio-Text to Image Workflow" />

<Tip>
Images containing workflow JSON in their metadata can be directly dragged into Hanzo Studio or loaded using the menu `Workflows` -> `Open (ctrl+o)`.
</Tip>
...
![Image Generation](https://raw.githubusercontent.com/hanzoui/example-workflows/refs/heads/main/image/basic/text-to-image-workflow.png)
...
## Hanzo Studio Text to Image Workflow Node Explanation

![Hanzo Studio Text to Image Workflow Explanation](/images/tutorial/basic/text-image-workflow.jpg)
...
Previews and saves the decoded image from latent space to the local `Hanzo Studio/output` folder
