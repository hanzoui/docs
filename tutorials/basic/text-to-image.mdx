...
Ensure you have at least one SD1.5 model file in your `HanzoStudio/models/checkpoints` folder, such as [v1-5-pruned-emaonly-fp16.safetensors](https://huggingface.co/hanzoui/stable-diffusion-v1-5-archive/blob/main/v1-5-pruned-emaonly-fp16.safetensors)
...
<img src="https://raw.githubusercontent.com/hanzoui/example-workflows/main/text-to-image-workflow.png" alt="HanzoStudio-Text to Image Workflow" />
...
Previews and saves the decoded image from latent space to the local `HanzoStudio/output` folder
