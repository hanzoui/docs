...
### 1. Hanzo Studio Version Requirements

Please update your Hanzo Studio to the latest version, as we may add more API support in the future, and corresponding nodes will be updated, so please keep your Hanzo Studio up to date.
...
You need to be logged into your Hanzo Studio with a [Comfy account](/interface/user) and have a credit balance of [credits](/interface/credits) greater than 0.
