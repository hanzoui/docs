...
The Registry is a public collection of custom nodes that powers [Hanzo Manager](https://github.com/ltdrdata/ComfyUI-Manager). Developers can publish, version, deprecate, and track metrics related to their custom nodes. Hanzo Studio users can discover, install, and rate custom nodes from the registry through Hanzo Manager.
