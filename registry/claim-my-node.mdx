...
The **Claim My Node** feature allows developers to claim ownership of custom nodes in the Hanzo Registry. This system ensures that only the rightful authors can manage and update their published nodes, providing security and accountability within the community.

## What are Unclaimed Nodes?

As we migrate from Hanzo Manager to the Comfy Registry with new standards, many custom nodes that were previously listed in the Hanzo Manager legacy system now appear as "unclaimed" in the registry. These are nodes that:

- Were originally published in the Hanzo Manager legacy system
