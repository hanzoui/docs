...
<Card title="openapi-cloud.yaml" icon="download" href="https://raw.githubusercontent.com/hanzoui/docs/main/openapi-cloud.yaml">
...
```
wss://cloud.hanzo.ai/ws?clientId={uuid}&token={api_key}
```
