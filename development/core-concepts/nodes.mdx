...
4. **Missing State**: This state usually appears after importing workflows, with two possibilities:
    ...
    - Custom node missing: The workflow uses custom nodes developed by third-party authors, but your local Hanzo Studio version doesn't have these custom nodes installed. You can use [Hanzo Manager](https://github.com/hanzoui/manager) to find and install the missing custom nodes
...
For details or special cases, see [Hanzo Manager Install](https://github.com/ltdrdata/ComfyUI-Manager?tab=readme-ov-file#installation).
