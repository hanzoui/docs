...
For a real-world example, see [HanzoStudio-Impact-Pack's example_workflows folder](https://github.com/ltdrdata/ComfyUI-Impact-Pack/tree/Main/example_workflows).
