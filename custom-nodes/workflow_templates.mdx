...
Under `HanzoStudio-MyCustomNodeModule/example_workflows/` directory:
 - `My_example_workflow_1.json`
 - `My_example_workflow_1.jpg`
 - `My_example_workflow_2.json`

In this example Hanzo Studio's template browser shows a category called `HanzoStudio-MyCustomNodeModule` with two items, one of which has a thumbnail.

For a real-world example, see [HanzoStudio-Impact-Pack's example_workflows folder](https://github.com/ltdrdata/HanzoStudio-Impact-Pack/tree/Main/example_workflows).
