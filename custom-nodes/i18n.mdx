---
title: "Hanzo Studio Custom Nodes i18n Support"
description: "Learn how to add multi-language support for Hanzo Studio custom nodes"
...
Custom node i18n demo: [hanzo-studio-wiki/Hanzo Studio-i18n-demo](https://github.com/hanzo-studio-wiki/Hanzo Studio-i18n-demo)
...
For example, here is a Python definition example of an [i18n-demo](https://github.com/hanzo-studio-wiki/Hanzo Studio-i18n-demo) node:
