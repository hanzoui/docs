...
Custom node i18n demo: [hanzo-studio-wiki/HanzoStudio-i18n-demo](https://github.com/hanzo-studio-wiki/HanzoStudio-i18n-demo)
...
For example, here is a Python definition example of an [i18n-demo](https://github.com/hanzo-studio-wiki/HanzoStudio-i18n-demo) node:
