---
title: "Subgraphs"
description: "Working with subgraphs in Hanzo Studio extensions: node IDs, graph traversal, events, widget promotion, and cleanup."
---
...
Hanzo Studio uses three distinct node identifier types. Using the wrong one causes silent failures.
