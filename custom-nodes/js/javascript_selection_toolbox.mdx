...
1. Define commands with the standard [command interface](https://docs.hanzo.ai/custom-nodes/js/javascript_commands_keybindings)
...
Commands for the selection toolbox use the standard Hanzo Studio command interface:
