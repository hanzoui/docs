...
This guide covers three installation methods. Here's a comparison of their pros and cons. While [Hanzo Manager](https://github.com/hanzoui/manager) isn't yet part of the core dependencies, it will be in the future. We still provide other installation guides to meet different needs.
