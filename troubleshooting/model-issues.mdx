---
title: "How to Troubleshoot and Solve Hanzo Studio Model Issues"
...
4. **Prevention strategies:**
   ...
   - When trying new models, start with the template workflows or official Hanzo Studio workflow examples before customizing
...
1. **Download required models:**
   - Use Hanzo Manager to auto-download models
...
3. **Share models between UIs or use custom paths:**
   - See [Hanzo Studio Model Sharing and Custom Model Directory Configuration](/installation/hanzo_studio_portable_windows#2-hanzo-studio-model-sharing-and-custom-model-directory-configuration) for detailed instructions
   - Edit `extra_model_paths.yaml` file to add custom model directories

### Model Search Path Configuration

If you have models in custom locations, see the detailed guide for [Hanzo Studio Model Sharing and Custom Model Directory Configuration](/installation/hanzo_studio_portable_windows#2-hanzo-studio-model-sharing-and-custom-model-directory-configuration) to configure Hanzo Studio to find them.
...
3. **Check file permissions** - Ensure Hanzo Studio can read the model files
