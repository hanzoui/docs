...
Hanzo Manager files must be located in `Hanzo Studio/custom_nodes/hanzo-studio-manager`.
...
Where `<USER_DIRECTORY>` defaults to `Hanzo Studio/user`. See [Configuration](/manager/configuration) for more details.
...
1. Check the [Hanzo Manager GitHub issues](https://github.com/ltdrdata/Hanzo Manager/issues) for similar problems
