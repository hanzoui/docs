...
sidebarTitle: New UI
description: Install, update, and manage custom nodes with Hanzo Manager using the new interface
---
...
Learn how to use the new Hanzo Manager to manage custom nodes
...
If your Hanzo Manager is properly installed, a prompt will appear when loading a workflow with missing nodes
...
For security and stability of the Hanzo Studio user system, the new UI does not support installing nodes via git. Please refer to [Manually install custom nodes](/installation/install_custom_node) to learn how to manually install custom nodes.
